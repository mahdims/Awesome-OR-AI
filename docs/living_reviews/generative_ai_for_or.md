...
### Front 1 (36 papers) — GROWING

**Density:** 0.17 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_evaluator, program_synthesis, llm_as_heuristic | **Problems:** linear_programming, optimization_modeling, mixed_integer_linear_programming, combinatorial_optimization, resource_allocation

*Unique methods:* actor_critic, anytime_algorithm, asymmetric_validation, attention_mechanism, auction_algorithm, autonomous_coding_agents, bayesian_optimization, beam_search, benchmark_creation, benchmark_design, bipartite_graphs, bootstrapping, canonical_intermediate_representation, causal_discovery, centralized_training_decentralized_execution, closed_loop_control, clustering, code_interpreter_feedback, dapo, data_augmentation, dataset_generation, deep_q_networks, deep_reinforcement_learning, deterministic_parser, differentiable_physics, differential_attention, digital_replicas, dual_reward_system, dynamic_path_reconstruction, empirical_study, ensemble_methods, epsilon_greedy_search, exact_optimization, execution_aware_modeling, expert_in_the_loop, formal_verification, generative_process_supervision, global_local_search, graph_isomorphism, graph_theory, greedy_search, hashing, heuristic_filtering, hierarchical_decomposition, hierarchical_retrieval_augmented_generation, human_llm_interaction, imitation_learning, instance_generation, intent_classification, irreducible_infeasible_subsystem_analysis, iterative_adaptive_revision, iterative_correction, kahneman_tversky_optimization, l1_regularization, lagrangian_relaxation, llm_as_data_synthesizer, llm_as_expert, llm_as_meta_optimizer, llm_as_model_generator, llm_as_semantic_generator, llm_as_solver, llm_as_verifier, loop_based_structure_recovery, lp_duality, makespan_minimization, mathematical_modeling, mathematical_optimization, mdp_modeling, memory_driven_planning, milp_general, minimum_bayes_risk_decoding, model_data_separation, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_armed_bandit, multi_head_attention, multi_robot_task_allocation, multimodal_ai, mutation_testing, natural_language_generation, nonlinear_programming, offline_adaptation, optimization_model_validation, optimization_solver, pairwise_preference_model, partial_kl_divergence, particle_swarm, prioritized_experience_replay, probabilistic_guarantee, pyscipopt, reinforce_plus_plus, rejection_sampling, retrieval_augmented_reasoning, reverse_engineering, reverse_socratic_method, rl_with_verifiable_rewards, sac_opt, sandboxed_execution, segment_weighted_grpo, self_refinement, semantic_alignment, semantic_validation, sentence_embedding, sibling_aware_expansion, simulation_optimization, smt_solvers, software_testing, solver_in_the_loop, sparse_state_storage, star, structure_aware_modeling, symbolic_planning, symbolic_pruning, symmetric_decomposable_graphs, systematic_literature_review, test_case_generation, test_time_adaptation, test_time_reinforcement_learning, test_time_scaling, textgrad, tool_use_agents, tree_of_thought, two_stage_reward_system, uct, uncertainty_estimation, vector_embedding, wasserstein_metric, weighted_direct_preference_optimization, weisfeiler_lehman_test
*Shared methods:* contrastive_learning, data_cleaning, data_synthesis, direct_preference_optimization, evolution_of_heuristics, expectation_maximization, genetic_algorithm, gradient_based_optimization, group_relative_policy_optimization, grpo, gurobi, in_context_learning, instruction_tuning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, meta_optimization, metaheuristics, milp_solver, mixed_integer_linear_programming, mixture_of_experts, multi_agent_llm, multi_agent_llm_system, multi_agent_system, neuro_symbolic_ai, neurosymbolic_ai, process_reward_model, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, self_consistency, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tree_of_thoughts
...
### Front 2 (33 papers) — GROWING

**Density:** 0.09 | **Methods:** llm_in_the_loop, llm_code_generation, llm_as_heuristic, program_synthesis, llm_fine_tuned | **Problems:** program_synthesis, resource_allocation, linear_programming, milp_general, job_shop_scheduling

*Unique methods:* ADMM, CP_SAT, GRPO, RL_GRPO, absolute_value_linearization, adaptive_algorithms, agentic_framework, agentic_workflow, aide, automated_algorithm_design, backtranslation, backward_generation, behavioral_verification, best_of_n_sampling, bestofn_sampling, bilevel_optimization, bilinear_linearization, bin_packing_heuristics, branch_and_bound, chain_of_experts, chain_of_thought, competitive_analysis, compiler_in_the_loop, compositional_prompting, constraint_programming_solver, continual_learning, cp_sat, cpmpy, crossover, curriculum_learning, cutting_planes, diagnosis_guided_repair, discrete_monotonic_optimization, distributionally_robust_optimization, diversity_aware_rank_based_sampling, dualreflect, dynamic_programming, dynamic_supervised_fine_tuning_policy_optimization, eoh, error_driven_learning, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, exact_linearization, few_shot_learning, fine_tuning, forward_generation, funsearch, gating_network, gdp_transformation, grammar_constrained_generation, graph_representation, greedy_algorithm, greedy_decoding, greedy_refinement, harness_engineering, hyperparameter_optimization, iis_diagnostics, ipython_kernel, k_means_clustering, karp_reductions, knowledge_graphs, lagrangian_duality, lexicographical_optimization, linear_fractional_linearization, literate_programming, llm_agent, llm_agents, llm_as_code_generator, llm_as_optimizer, llm_objective_formulation, low_rank_adaptation, lower_bound_estimation, marge_loss, mathematical_programming, milp_reformulation, min_max_linearization, minizinc, minizinc_modeling, mixed_integer_programming, model_context_protocol, modeling_language, monotone_transformation_linearization, mstc_ahd, mutation, nsga_ii, online_scheduling, ordered_eviction, parameter_efficient_fine_tuning, pattern_detection, ppo, preference_learning, problem_formulation, propen, qlora, random_forest, react_framework, reevo, reflected_cot, reflection_mechanism, reflexion, reinforce, reinforcement_learning_alignment, reinforcement_learning_with_verifiable_rewards, relation_modeling, repeated_sampling, retrieval_augmented_in_context_learning, reverse_data_synthesis, reward_modeling, rl_ppo, rlhf, robust_optimization, rsome, rule_based_reformulation, sample_average_approximation, self_instruct, self_reflection, self_verification, sensitivity_analysis, solution_majority_voting, solver_based_perturbation, stochastic_optimization, surrogate_assisted_evolutionary_algorithms, temperature_sampling, tool_augmented_llm, vanilla_prompting, variable_fixing_heuristic
*Shared methods:* constraint_programming, contrastive_learning, data_synthesis, debugging, direct_preference_optimization, evolution_of_heuristics, genetic_algorithm, group_relative_policy_optimization, grpo, in_context_learning, instruction_tuning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, majority_voting, meta_optimization, metaheuristics, milp_solver, mixture_of_experts, multi_agent_llm, multi_agent_system, neuro_symbolic_ai, neurosymbolic_ai, process_reward_model, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tool_use, tree_of_thoughts

This front is characterized by the development of agentic LLM frameworks and fine-tuning strategies for the synthesis, evolution, and verification of operations research (OR) models and algorithms. Key frameworks like ReLoop, EvoOR-Agent, EvoCut (FunSearch lineage), AutoOR (GRPO lineage), MIND, and EngiAgent are central, tackling problems ranging from program synthesis for MILP and Constraint Programming to the automated design of heuristics and solver plugins. A strong emphasis is placed on ensuring the correctness and reliability of LLM-generated artifacts through rigorous verification mechanisms.

Significant contributions include ReLoop's behavioral verification for LLM-generated optimization models, achieving +27.9pp execution accuracy on RetailOpt-190. EvoOR-Agent uses AOE networks for co-evolution, improving IndustryOR performance by up to 17%. EvoCut (FunSearch) generates MILP cuts, reducing gaps by 17-57% on TSPLIB and JSSP. AutoOR leverages GRPO and backtranslation for autoformalization, enabling an 8B model to match Gemini 3 Pro and achieve 48.98% on non-linear pump network tasks. MIND introduces DFPO and error-driven data synthesis, boosting a 7B model's performance by +31.0% on IndustryOR. Benchmarks like CO-Bench, HeuriGym, OptiVerse, DCP-Bench-Open, and Text2Zinc are critical for evaluating LLM agents in algorithm search and constraint modeling, revealing challenges like overfitting to example instances and the heuristic trap. EquivaMap offers a novel solver-verified equivalence checking for formulations, achieving 100% accuracy on its dataset.
...
**Density:** 0.13 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_heuristic, program_synthesis, llm_as_evaluator | **Problems:** milp_general, combinatorial_optimization, optimization_modeling, job_shop_scheduling, facility_location

*Unique methods:* adam_optimizer, agentic_model, ai_agents, apollo_milp, augmented_lagrangian_method, automated_experimentation, automatic_symbolic_dualization, bi_gcn, black_box_optimization, callbacks, canonical_graph_edit_distance, canonicalization, clustergcn, conditional_flow_matching, cross_encoder_reranking, differentiable_optimization, dirichlet_process_mixture_model, domain_specific_languages, dynamic_weight_adjustment, error_analysis, evaluation_framework, evolutionary_search, expert_prompting, fixed_point_relaxation, flow_matching, function_calling, gat, gaussian_process, gaussian_reparameterization, generative_models, global_constraints, gradient_descent, graph_edit_distance, graph_neural_networks, heuristic_design, hierarchical_chunking, hierarchical_reinforcement_learning, hyper_heuristics, indicator_variables, large_language_models, llm_evaluation, logsumexp_approximation, lookahead_mechanism, memory_compression, metacognition, metadata_augmented_indexing, multi_agent_coordination, multi_turn_feedback, multimodal_llm, neural_diving, non_parametric_modeling, options_framework, piecewise_linear_constraints, pmvb, predict_and_search, progressive_specialization_training, pushdown_automaton, reflection, reward_design, sampling_and_reweighting, self_reflective_error_correction, semi_markov_decision_process, sifting, simulation_environment, special_ordered_sets, structure_detection, structured_output_parsing, topological_sort, tree_search, tri_gcn, two_stage_retrieval, utpc_framework, virtual_reinforcement_learning, warm_starting, weighted_sum_method
*Shared methods:* constraint_programming, data_cleaning, debugging, evolution_of_heuristics, expectation_maximization, gradient_based_optimization, grpo, gurobi, in_context_learning, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, majority_voting, mixed_integer_linear_programming, multi_agent_llm_system, multi_agent_system, program_synthesis, reinforcement_learning, retrieval_augmented_generation, self_consistency, supervised_fine_tuning, supervised_learning, tool_use

This front explores advanced LLM-driven methodologies for Operations Research, focusing on automated optimization modeling, heuristic discovery, and code generation. Key themes include the development of multi-agent architectures like GALA and OptiMUS-0.3 for translating natural language into formal optimization models, and hierarchical frameworks such as MiCo and OR-Agent, which leverage LLMs for evolving problem-specific heuristics and managing complex research workflows. The front also investigates novel techniques for improving LLM reliability and efficiency in OR tasks, such as metadata-augmented RAG in CHORUS and domain-specific language regulation for constraint specification.

Specific contributions include GALA's multi-agent approach for text-to-MiniZinc translation, outperforming CoT with a 57% execution rate on TEXT2ZINC. MiCo, a FunSearch-lineage framework, achieved a 96.9% competitive ratio against Gurobi for dynamic VM scheduling, significantly surpassing Deep RL by ~11% on Huawei/Azure traces. OptiMUS-0.3 demonstrated state-of-the-art MILP formulation from natural language, outperforming GPT-4o by ~40% on the NLP4LP benchmark through its connection graph and structure detection agents. OptiMind further improved MILP formulation accuracy by up to 20.7% using fine-tuning and expert hints, while OR-Agent achieved a ~2x improvement over FunSearch in automated algorithm discovery for TSP and CVRP by employing a tree-structured research workflow and environment probing. CHORUS enhanced LP code generation, enabling Llama-3-70B to match GPT-4 performance (57% accuracy) via metadata-augmented RAG. DualSchool introduced Canonical Graph Edit Distance (CGED) for robust evaluation of Primal-to-Dual Conversion, revealing LLM limitations. FMIP and GauS, while not LLM-centric, contributed hybrid guidance mechanisms for MILP and differentiable scheduling via Gaussian reparameterization, respectively.
...
**TRUE SYNTHESIS** | score=0.96 | Front 0 → Front 1, Front 2
...
**TRUE SYNTHESIS** | score=0.81 | Front 2 → Front 1, Front 0
...
**TRUE SYNTHESIS** | score=0.75 | Front 2 → Front 1, Front 0
...
**TRUE SYNTHESIS** | score=0.75 | Front 2 → Front 1
...
**TRUE SYNTHESIS** | score=0.75 | Front 0 → Front 1, Front 2
