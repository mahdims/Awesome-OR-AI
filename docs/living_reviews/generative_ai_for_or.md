...
### Front 0 (23 papers) — STABLE

**Density:** 0.06 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_heuristic, llm_as_evaluator, program_synthesis | **Problems:** linear_programming, mixed_integer_linear_programming, combinatorial_optimization, resource_allocation, optimization_modeling

*Unique methods:* ADMM, adam_optimizer, agentic_model, agentic_workflow, augmented_lagrangian_method, automated_algorithm_design, automated_experimentation, backward_generation, beam_search, behavioral_verification, bilevel_optimization, bin_packing_heuristics, black_box_optimization, continual_learning, curriculum_learning, dataset_generation, diagnosis_guided_repair, differentiable_optimization, differentiable_physics, dirichlet_process_mixture_model, distributionally_robust_optimization, diversity_aware_rank_based_sampling, domain_specific_languages, dualreflect, dynamic_path_reconstruction, dynamic_supervised_fine_tuning_policy_optimization, dynamic_weight_adjustment, epsilon_greedy_search, error_driven_learning, evolutionary_algorithms, evolutionary_search, expert_in_the_loop, few_shot_learning, fixed_point_relaxation, forward_generation, function_calling, gaussian_process, gaussian_reparameterization, generative_process_supervision, global_constraints, global_local_search, gradient_descent, greedy_decoding, greedy_search, grpo, heuristic_design, hierarchical_reinforcement_learning, human_llm_interaction, hyper_heuristics, hyperparameter_optimization, iis_diagnostics, irreducible_infeasible_subsystem_analysis, iterative_correction, l1_regularization, lagrangian_duality, large_language_models, llm_as_optimizer, llm_as_semantic_generator, logsumexp_approximation, lookahead_mechanism, loop_based_structure_recovery, low_rank_adaptation, marge_loss, memory_compression, memory_driven_planning, metacognition, mixture_of_experts, model_data_separation, multimodal_llm, mutation_testing, natural_language_generation, non_parametric_modeling, optimization_model_validation, optimization_solver, options_framework, pairwise_preference_model, ppo, preference_learning, problem_formulation, process_reward_model, progressive_specialization_training, propen, pushdown_automaton, reflected_cot, reflection, reflexion, reinforce, reinforcement_learning_alignment, reinforcement_learning_with_verifiable_rewards, reverse_data_synthesis, reverse_engineering, reward_design, rl_ppo, rlhf, rsome, sac_opt, sample_average_approximation, self_instruct, self_reflection, semantic_alignment, semantic_validation, semi_markov_decision_process, sensitivity_analysis, sentence_embedding, sibling_aware_expansion, simulation_environment, software_testing, solver_based_perturbation, solver_in_the_loop, sparse_state_storage, star, stochastic_optimization, structure_aware_modeling, temperature_sampling, test_case_generation, test_time_scaling, topological_sort, tree_of_thought, tree_search, utpc_framework, virtual_reinforcement_learning, weighted_direct_preference_optimization, weighted_sum_method
*Shared methods:* benchmark_design, chain_of_thought, constraint_programming, data_synthesis, debugging, direct_preference_optimization, dynamic_programming, evolution_of_heuristics, expectation_maximization, funsearch, generative_models, genetic_algorithm, gradient_based_optimization, group_relative_policy_optimization, in_context_learning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, majority_voting, meta_optimization, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, neuro_symbolic_ai, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, robust_optimization, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tool_use, tree_of_thoughts
...
### Front 1 (21 papers) — GROWING

**Density:** 0.14 | **Methods:** llm_in_the_loop, llm_code_generation, program_synthesis, llm_as_heuristic, llm_as_evaluator | **Problems:** milp_general, combinatorial_optimization, scheduling, job_shop_scheduling, bin_packing

*Unique methods:* absolute_value_linearization, actor_critic, agentic_framework, aide, anytime_algorithm, apollo_milp, attention_mechanism, auction_algorithm, bayesian_optimization, bestofn_sampling, bi_gcn, bilinear_linearization, branch_and_bound, canonical_intermediate_representation, causal_discovery, centralized_training_decentralized_execution, chain_of_experts, closed_loop_control, clustergcn, compositional_prompting, conditional_flow_matching, constraint_programming_solver, contrastive_learning, cp_sat, cpmpy, crossover, cutting_planes, deep_reinforcement_learning, differential_attention, digital_replicas, ensemble_methods, eoh, evolutionary_algorithm, exact_linearization, exact_optimization, flow_matching, formal_verification, gat, gdp_transformation, graph_neural_networks, greedy_refinement, hierarchical_retrieval_augmented_generation, imitation_learning, intent_classification, ipython_kernel, iterative_adaptive_revision, k_means_clustering, karp_reductions, knowledge_graphs, lagrangian_relaxation, lexicographical_optimization, linear_fractional_linearization, llm_agent, llm_agents, llm_as_code_generator, llm_as_expert, llm_as_meta_optimizer, llm_objective_formulation, makespan_minimization, mathematical_optimization, metaheuristics, milp_general, milp_reformulation, min_max_linearization, minizinc, minizinc_modeling, mixed_integer_programming, model_context_protocol, modeling_language, monotone_transformation_linearization, mstc_ahd, multi_agent_reinforcement_learning, multi_head_attention, multi_robot_task_allocation, multimodal_ai, mutation, neural_diving, neurosymbolic_ai, nonlinear_programming, nsga_ii, parameter_efficient_fine_tuning, particle_swarm, pattern_detection, pmvb, predict_and_search, prioritized_experience_replay, probabilistic_guarantee, qlora, random_forest, react_framework, reevo, reflection_mechanism, repeated_sampling, retrieval_augmented_in_context_learning, rule_based_reformulation, sampling_and_reweighting, self_verification, simulation_optimization, solution_majority_voting, symbolic_planning, textgrad, tool_use_agents, tri_gcn, uncertainty_estimation, vanilla_prompting, variable_fixing_heuristic, warm_starting, wasserstein_metric
*Shared methods:* benchmark_design, chain_of_thought, constraint_programming, data_synthesis, direct_preference_optimization, dynamic_programming, evolution_of_heuristics, expectation_maximization, funsearch, generative_models, genetic_algorithm, gradient_based_optimization, in_context_learning, instruction_tuning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, meta_optimization, milp_solver, mixed_integer_linear_programming, multi_agent_system, neuro_symbolic_ai, program_synthesis, prompt_engineering, retrieval_augmented_generation, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, tool_use, tree_of_thoughts
...
### Front 2 (21 papers) — DECLINING

**Density:** 0.34 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_evaluator, program_synthesis, llm_fine_tuned | **Problems:** linear_programming, optimization_modeling, mixed_integer_linear_programming, automated_optimization_modeling, program_synthesis

*Unique methods:* adaptive_algorithms, ai_agents, asymmetric_validation, automatic_symbolic_dualization, autonomous_coding_agents, benchmark_creation, bipartite_graphs, bootstrapping, callbacks, canonical_graph_edit_distance, canonicalization, code_interpreter_feedback, competitive_analysis, compiler_in_the_loop, cross_encoder_reranking, data_augmentation, data_cleaning, deep_q_networks, deterministic_parser, dual_reward_system, empirical_study, error_analysis, evaluation_framework, execution_aware_modeling, expert_prompting, graph_edit_distance, graph_isomorphism, graph_theory, greedy_algorithm, gurobi, hashing, heuristic_filtering, hierarchical_chunking, hierarchical_decomposition, indicator_variables, instance_generation, kahneman_tversky_optimization, literate_programming, llm_as_data_synthesizer, llm_as_model_generator, llm_as_solver, llm_evaluation, lower_bound_estimation, mathematical_modeling, mdp_modeling, metadata_augmented_indexing, minimum_bayes_risk_decoding, multi_agent_coordination, multi_armed_bandit, multi_turn_feedback, online_scheduling, ordered_eviction, partial_kl_divergence, piecewise_linear_constraints, pyscipopt, reinforce_plus_plus, rejection_sampling, reverse_socratic_method, self_consistency, self_refinement, self_reflective_error_correction, sifting, smt_solvers, special_ordered_sets, structure_detection, structured_output_parsing, symbolic_pruning, symmetric_decomposable_graphs, systematic_literature_review, test_time_adaptation, test_time_reinforcement_learning, two_stage_retrieval, two_stage_reward_system, uct, vector_embedding, weisfeiler_lehman_test
*Shared methods:* data_synthesis, debugging, group_relative_policy_optimization, in_context_learning, instruction_tuning, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, majority_voting, milp_solver, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, robust_optimization, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation
...
**TRUE SYNTHESIS** | score=0.83 | Front 1 → Front 2, Front 0
...
**TRUE SYNTHESIS** | score=0.80 | Front 0 → Front 2, Front 1
...
**TRUE SYNTHESIS** | score=0.78 | Front 0 → Front 2, Front 1
