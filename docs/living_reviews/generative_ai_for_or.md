...
### Front 3 (11 papers) — STABLE

**Density:** 0.51 | **Methods:** llm_in_the_loop, llm_code_generation, program_synthesis, llm_as_heuristic, llm_as_evaluator | **Problems:** linear_programming, optimization_problem_formulation, constrained_optimization, milp_general, mixed_integer_linear_programming
...
### Front 2 (10 papers) — STABLE

**Density:** 0.42 | **Methods:** llm_as_evaluator, llm_in_the_loop, llm_code_generation, llm_as_heuristic, program_synthesis | **Problems:** linear_programming, optimization_modeling, mixed_integer_linear_programming, combinatorial_optimization, program_synthesis
...
### Front 8 (9 papers) — STABLE

**Density:** 0.36 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_heuristic, program_synthesis, iterative_refinement | **Problems:** scheduling, linear_programming, bin_packing, mixed_integer_linear_programming, tsp
...
### Front 1 (8 papers) — STABLE

**Density:** 0.89 | **Methods:** llm_in_the_loop, llm_code_generation, llm_as_evaluator, llm_fine_tuned, llm_as_heuristic | **Problems:** optimization_modeling, program_synthesis, linear_programming, mixed_integer_programming, lp_modeling
...
**TRUE SYNTHESIS** | score=0.76 | Front 3 → Front 1, Front 2, Front 8
...
**TRUE SYNTHESIS** | score=0.75 | Front 3 → Front 1, Front 2, Front 8
...
**TRUE SYNTHESIS** | score=0.75 | Front 2 → Front 8, Front 1, Front 3
...
**TRUE SYNTHESIS** | score=0.71 | Front 2 → Front 1, Front 3, Front 8
...
**TRUE SYNTHESIS** | score=0.70 | Front 3 → Front 1, Front 2
