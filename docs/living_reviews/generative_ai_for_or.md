...
### Front 1 (24 papers) — GROWING

**Density:** 0.26 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_evaluator, llm_fine_tuned, program_synthesis | **Problems:** optimization_modeling, linear_programming, mixed_integer_linear_programming, integer_programming, mixed_integer_programming

*Unique methods:* ADMM, absolute_value_linearization, adam_optimizer, adaptive_algorithms, agentic_workflow, ai_agents, augmented_lagrangian_method, automated_algorithm_design, automatic_symbolic_dualization, bayesian_optimization, behavioral_verification, benchmark_creation, bilinear_linearization, bin_packing_heuristics, bipartite_graphs, bootstrapping, callbacks, canonical_graph_edit_distance, canonicalization, causal_discovery, code_interpreter_feedback, competitive_analysis, continual_learning, data_augmentation, data_cleaning, dataset_generation, deterministic_parser, diagnosis_guided_repair, differentiable_optimization, digital_replicas, dual_reward_system, empirical_study, ensemble_methods, error_analysis, evaluation_framework, evolutionary_algorithms, exact_linearization, expert_in_the_loop, fixed_point_relaxation, gaussian_reparameterization, gdp_transformation, gradient_descent, graph_edit_distance, graph_isomorphism, graph_theory, greedy_algorithm, gurobi, hashing, heuristic_filtering, hierarchical_decomposition, hierarchical_retrieval_augmented_generation, human_llm_interaction, hyperparameter_optimization, iis_diagnostics, indicator_variables, instance_generation, iterative_adaptive_revision, kahneman_tversky_optimization, linear_fractional_linearization, llm_as_data_synthesizer, llm_as_meta_optimizer, llm_as_model_generator, llm_as_solver, llm_evaluation, logsumexp_approximation, loop_based_structure_recovery, lower_bound_estimation, mathematical_modeling, meta_optimization, milp_reformulation, min_max_linearization, model_data_separation, modeling_language, monotone_transformation_linearization, multi_agent_coordination, multi_armed_bandit, multi_turn_feedback, natural_language_generation, online_scheduling, ordered_eviction, partial_kl_divergence, particle_swarm, pattern_detection, piecewise_linear_constraints, problem_formulation, pyscipopt, reinforce_plus_plus, rejection_sampling, reverse_engineering, reverse_socratic_method, rule_based_reformulation, self_refinement, self_reflective_error_correction, semantic_validation, sensitivity_analysis, sifting, simulation_optimization, smt_solvers, solver_based_perturbation, special_ordered_sets, structure_aware_modeling, structure_detection, symbolic_pruning, symmetric_decomposable_graphs, systematic_literature_review, test_time_adaptation, test_time_reinforcement_learning, topological_sort, two_stage_reward_system, uct, weisfeiler_lehman_test
*Shared methods:* benchmark_design, chain_of_thought, data_synthesis, debugging, evolution_of_heuristics, expectation_maximization, genetic_algorithm, group_relative_policy_optimization, in_context_learning, instruction_tuning, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, majority_voting, metaheuristics, milp_solver, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, robust_optimization, self_consistency, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation
...
### Front 2 (24 papers) — DECLINING

**Density:** 0.06 | **Methods:** llm_in_the_loop, llm_code_generation, llm_as_evaluator, llm_as_heuristic, program_synthesis | **Problems:** linear_programming, combinatorial_optimization, mixed_integer_linear_programming, traveling_salesman_problem, optimization_modeling

*Unique methods:* agentic_model, anytime_algorithm, apollo_milp, asymmetric_validation, auction_algorithm, autonomous_coding_agents, backward_generation, beam_search, bi_gcn, bilevel_optimization, canonical_intermediate_representation, closed_loop_control, clustergcn, compiler_in_the_loop, conditional_flow_matching, cross_encoder_reranking, curriculum_learning, dapo, deep_q_networks, direct_preference_optimization, distributionally_robust_optimization, diversity_aware_rank_based_sampling, dualreflect, dynamic_weight_adjustment, epsilon_greedy_search, exact_optimization, execution_aware_modeling, expert_prompting, few_shot_learning, flow_matching, formal_verification, forward_generation, function_calling, gat, generative_process_supervision, global_constraints, graph_neural_networks, greedy_decoding, greedy_search, heuristic_design, hierarchical_chunking, hierarchical_reinforcement_learning, intent_classification, iterative_correction, lagrangian_duality, literate_programming, llm_as_optimizer, lookahead_mechanism, low_rank_adaptation, makespan_minimization, marge_loss, mdp_modeling, metacognition, metadata_augmented_indexing, milp_general, minimum_bayes_risk_decoding, multi_robot_task_allocation, multimodal_ai, multimodal_llm, neural_diving, nonlinear_programming, optimization_solver, options_framework, pairwise_preference_model, pmvb, ppo, predict_and_search, preference_learning, probabilistic_guarantee, process_reward_model, progressive_specialization_training, propen, reflected_cot, reflexion, reinforce, reinforcement_learning_alignment, reinforcement_learning_with_verifiable_rewards, reward_design, rl_ppo, rl_with_verifiable_rewards, rlhf, rsome, sac_opt, sample_average_approximation, sampling_and_reweighting, sandboxed_execution, self_instruct, self_reflection, semantic_alignment, semi_markov_decision_process, sentence_embedding, simulation_environment, stochastic_optimization, structured_output_parsing, symbolic_planning, temperature_sampling, test_time_scaling, textgrad, tool_use_agents, tree_of_thought, tri_gcn, two_stage_retrieval, uncertainty_estimation, utpc_framework, vector_embedding, virtual_reinforcement_learning, warm_starting, weighted_direct_preference_optimization, weighted_sum_method
*Shared methods:* benchmark_design, chain_of_thought, constraint_programming, contrastive_learning, data_synthesis, debugging, dynamic_programming, evolution_of_heuristics, funsearch, generative_models, genetic_algorithm, gradient_based_optimization, group_relative_policy_optimization, grpo, in_context_learning, iterative_refinement, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, majority_voting, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, neurosymbolic_ai, program_synthesis, prompt_engineering, reinforcement_learning, retrieval_augmented_generation, robust_optimization, self_consistency, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tool_use
...
### Front 0 (18 papers) — GROWING

**Density:** 0.20 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_heuristic, program_synthesis, iterative_refinement | **Problems:** job_shop_scheduling, resource_allocation, scheduling, bin_packing, program_synthesis

*Unique methods:* actor_critic, agentic_framework, aide, attention_mechanism, automated_experimentation, bestofn_sampling, black_box_optimization, branch_and_bound, centralized_training_decentralized_execution, chain_of_experts, compositional_prompting, constraint_programming_solver, cp_sat, cpmpy, crossover, cutting_planes, deep_reinforcement_learning, differentiable_physics, differential_attention, dirichlet_process_mixture_model, domain_specific_languages, dynamic_path_reconstruction, dynamic_supervised_fine_tuning_policy_optimization, eoh, error_driven_learning, evolutionary_algorithm, evolutionary_search, gaussian_process, global_local_search, greedy_refinement, hyper_heuristics, imitation_learning, ipython_kernel, irreducible_infeasible_subsystem_analysis, k_means_clustering, karp_reductions, knowledge_graphs, l1_regularization, lagrangian_relaxation, large_language_models, lexicographical_optimization, llm_agent, llm_agents, llm_as_code_generator, llm_as_expert, llm_as_semantic_generator, llm_objective_formulation, mathematical_optimization, memory_compression, memory_driven_planning, minizinc, minizinc_modeling, mixed_integer_programming, mixture_of_experts, model_context_protocol, mstc_ahd, multi_agent_reinforcement_learning, multi_head_attention, mutation, mutation_testing, neuro_symbolic_ai, non_parametric_modeling, nsga_ii, optimization_model_validation, parameter_efficient_fine_tuning, prioritized_experience_replay, pushdown_automaton, qlora, random_forest, react_framework, reevo, reflection, reflection_mechanism, repeated_sampling, retrieval_augmented_in_context_learning, reverse_data_synthesis, self_verification, sibling_aware_expansion, software_testing, solution_majority_voting, solver_in_the_loop, sparse_state_storage, star, test_case_generation, tree_of_thoughts, tree_search, vanilla_prompting, variable_fixing_heuristic, wasserstein_metric
*Shared methods:* chain_of_thought, constraint_programming, contrastive_learning, data_synthesis, dynamic_programming, evolution_of_heuristics, expectation_maximization, funsearch, generative_models, gradient_based_optimization, group_relative_policy_optimization, grpo, in_context_learning, instruction_tuning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, metaheuristics, milp_solver, monte_carlo_tree_search, multi_agent_system, neurosymbolic_ai, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, self_correction, supervised_fine_tuning, supervised_learning, tool_use
...
**TRUE SYNTHESIS** | score=0.85 | Front 2 → Front 1, Front 0
...
**TRUE SYNTHESIS** | score=0.83 | Front 0 → Front 1, Front 2
...
**TRUE SYNTHESIS** | score=0.82 | Front 2 → Front 1, Front 0
...
**TRUE SYNTHESIS** | score=0.82 | Front 0 → Front 1, Front 2
...
**TRUE SYNTHESIS** | score=0.78 | Front 2 → Front 1, Front 0
