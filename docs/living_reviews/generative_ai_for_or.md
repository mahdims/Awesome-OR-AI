...
### Front 1 (31 papers) — GROWING

**Density:** 0.16 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_evaluator, program_synthesis, llm_as_heuristic | **Problems:** linear_programming, optimization_modeling, program_synthesis, mixed_integer_linear_programming, combinatorial_optimization

*Unique methods:* RL_GRPO, absolute_value_linearization, adam_optimizer, agentic_model, apollo_milp, asymmetric_validation, augmented_lagrangian_method, automated_experimentation, autonomous_coding_agents, backtranslation, behavioral_verification, benchmark_creation, bi_gcn, bilinear_linearization, bipartite_graphs, black_box_optimization, bootstrapping, canonical_intermediate_representation, clustergcn, code_interpreter_feedback, conditional_flow_matching, cross_encoder_reranking, dapo, deep_q_networks, deterministic_parser, diagnosis_guided_repair, differentiable_optimization, dirichlet_process_mixture_model, domain_specific_languages, dual_reward_system, empirical_study, evolutionary_search, exact_linearization, exact_optimization, execution_aware_modeling, expert_prompting, fixed_point_relaxation, flow_matching, function_calling, gat, gaussian_process, gaussian_reparameterization, gdp_transformation, generative_models, generative_process_supervision, gradient_descent, graph_isomorphism, graph_neural_networks, graph_theory, hashing, heuristic_filtering, hierarchical_chunking, hierarchical_decomposition, hierarchical_retrieval_augmented_generation, hyper_heuristics, iis_diagnostics, instance_generation, iterative_adaptive_revision, iterative_correction, kahneman_tversky_optimization, large_language_models, linear_fractional_linearization, llm_as_data_synthesizer, llm_as_model_generator, llm_as_solver, llm_research_agent, logsumexp_approximation, mathematical_modeling, mdp_modeling, memory_compression, metacognition, metadata_augmented_indexing, milp_reformulation, min_max_linearization, minimum_bayes_risk_decoding, modeling_language, monotone_transformation_linearization, multi_armed_bandit, multimodal_llm, neural_diving, non_parametric_modeling, nonlinear_programming, optimization_solver, partial_kl_divergence, pattern_detection, pmvb, predict_and_search, progressive_specialization_training, pushdown_automaton, pyscipopt, reflection, reinforce_plus_plus, rejection_sampling, reverse_socratic_method, reward_design, rl_with_verifiable_rewards, rule_based_reformulation, sac_opt, sampling_and_reweighting, sandboxed_execution, self_refinement, semantic_alignment, sensitivity_analysis, sentence_embedding, simulation_environment, smt_solvers, solver_based_perturbation, structured_output_parsing, symbolic_pruning, symmetric_decomposable_graphs, systematic_literature_review, test_time_adaptation, test_time_reinforcement_learning, test_time_scaling, topological_sort, tree_search, tri_gcn, two_stage_retrieval, two_stage_reward_system, uct, utpc_framework, vector_embedding, virtual_reinforcement_learning, warm_starting, weighted_direct_preference_optimization, weisfeiler_lehman_test
*Shared methods:* benchmark_design, chain_of_thought, constraint_programming, curriculum_learning, data_augmentation, data_cleaning, data_synthesis, evolution_of_heuristics, expectation_maximization, gradient_based_optimization, group_relative_policy_optimization, grpo, gurobi, in_context_learning, instruction_tuning, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, milp_solver, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, process_reward_model, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, self_consistency, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tool_use
...
### Front 0 (21 papers) — STABLE

**Density:** 0.17 | **Methods:** llm_in_the_loop, llm_code_generation, llm_as_heuristic, program_synthesis, llm_fine_tuned | **Problems:** combinatorial_optimization, scheduling, resource_allocation, job_shop_scheduling, bin_packing

*Unique methods:* ADMM, adaptive_algorithms, agentic_framework, agentic_workflow, aide, anytime_algorithm, auction_algorithm, automated_algorithm_design, bestofn_sampling, bin_packing_heuristics, branch_and_bound, chain_of_experts, closed_loop_control, competitive_analysis, compiler_in_the_loop, compositional_prompting, constraint_programming_solver, continual_learning, cp_sat, cpmpy, crossover, cutting_planes, dataset_generation, discrete_monotonic_optimization, diversity_aware_rank_based_sampling, dynamic_weight_adjustment, eoh, evolutionary_algorithm, evolutionary_algorithms, expert_in_the_loop, fine_tuning, funsearch, gating_network, grammar_constrained_generation, greedy_algorithm, greedy_refinement, heuristic_design, hierarchical_reinforcement_learning, human_llm_interaction, hyperparameter_optimization, ipython_kernel, irreducible_infeasible_subsystem_analysis, k_means_clustering, karp_reductions, knowledge_graphs, lexicographical_optimization, literate_programming, llm_agent, llm_agents, llm_as_code_generator, llm_iterative_refinement, llm_objective_formulation, lookahead_mechanism, loop_based_structure_recovery, low_rank_adaptation, lower_bound_estimation, makespan_minimization, milp_general, minizinc, minizinc_modeling, mixed_integer_programming, model_context_protocol, model_data_separation, mstc_ahd, multi_robot_task_allocation, mutation, natural_language_generation, nsga_ii, online_scheduling, options_framework, ordered_eviction, parameter_efficient_fine_tuning, problem_formulation, qlora, random_forest, react_framework, reevo, reflection_mechanism, repeated_sampling, retrieval_augmented_in_context_learning, reverse_engineering, self_verification, semantic_validation, semi_markov_decision_process, solution_majority_voting, solver_in_the_loop, star, structure_aware_modeling, tool_use_agents, vanilla_prompting, variable_fixing_heuristic, weighted_sum_method
*Shared methods:* benchmark_design, chain_of_thought, constraint_programming, contrastive_learning, direct_preference_optimization, dynamic_programming, evolution_of_heuristics, grpo, in_context_learning, instruction_tuning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, meta_optimization, metaheuristics, milp_solver, mixed_integer_linear_programming, mixture_of_experts, neuro_symbolic_ai, neurosymbolic_ai, program_synthesis, prompt_engineering, reinforcement_learning, retrieval_augmented_generation, robust_optimization, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, tool_use, tree_of_thoughts
...
**Density:** 0.12 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_evaluator, llm_as_heuristic, llm_fine_tuned | **Problems:** resource_allocation, linear_programming, constrained_optimization, optimization_modeling, mixed_integer_linear_programming

*Unique methods:* actor_critic, ai_agents, attention_mechanism, automatic_symbolic_dualization, backward_generation, bayesian_optimization, beam_search, bilevel_optimization, callbacks, canonical_graph_edit_distance, canonicalization, causal_discovery, centralized_training_decentralized_execution, debugging, deep_reinforcement_learning, differentiable_physics, differential_attention, digital_replicas, distributionally_robust_optimization, dualreflect, dynamic_path_reconstruction, dynamic_supervised_fine_tuning_policy_optimization, ensemble_methods, epsilon_greedy_search, error_analysis, error_driven_learning, evaluation_framework, few_shot_learning, formal_verification, forward_generation, genetic_algorithm, global_constraints, global_local_search, graph_edit_distance, greedy_decoding, greedy_search, imitation_learning, indicator_variables, intent_classification, l1_regularization, lagrangian_duality, lagrangian_relaxation, llm_as_expert, llm_as_meta_optimizer, llm_as_optimizer, llm_as_semantic_generator, llm_evaluation, majority_voting, marge_loss, mathematical_optimization, memory_driven_planning, multi_agent_coordination, multi_agent_reinforcement_learning, multi_head_attention, multi_turn_feedback, multimodal_ai, mutation_testing, optimization_model_validation, pairwise_preference_model, particle_swarm, piecewise_linear_constraints, ppo, preference_learning, prioritized_experience_replay, probabilistic_guarantee, propen, reflected_cot, reflexion, reinforce, reinforcement_learning_alignment, reinforcement_learning_with_verifiable_rewards, reverse_data_synthesis, rl_ppo, rlhf, rsome, sample_average_approximation, self_instruct, self_reflection, self_reflective_error_correction, sibling_aware_expansion, sifting, simulation_optimization, software_testing, sparse_state_storage, special_ordered_sets, stochastic_optimization, structure_detection, symbolic_planning, temperature_sampling, test_case_generation, textgrad, tree_of_thought, uncertainty_estimation, wasserstein_metric
*Shared methods:* chain_of_thought, constraint_programming, contrastive_learning, curriculum_learning, data_augmentation, data_cleaning, data_synthesis, direct_preference_optimization, dynamic_programming, evolution_of_heuristics, expectation_maximization, gradient_based_optimization, group_relative_policy_optimization, grpo, gurobi, in_context_learning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, meta_optimization, metaheuristics, mixed_integer_linear_programming, mixture_of_experts, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, neuro_symbolic_ai, neurosymbolic_ai, process_reward_model, program_synthesis, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, robust_optimization, self_consistency, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tree_of_thoughts
