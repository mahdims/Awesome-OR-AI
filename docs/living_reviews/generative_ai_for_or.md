...
### Front 1 (26 papers) — STABLE

**Density:** 0.05 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_evaluator, llm_as_heuristic, program_synthesis | **Problems:** mixed_integer_linear_programming, linear_programming, combinatorial_optimization, milp_general, constrained_optimization

*Unique methods:* ADMM, absolute_value_linearization, adam_optimizer, adaptive_algorithms, agentic_model, agentic_workflow, augmented_lagrangian_method, automated_algorithm_design, backward_generation, beam_search, benchmark_design, bilevel_optimization, bilinear_linearization, bin_packing_heuristics, canonical_intermediate_representation, competitive_analysis, continual_learning, cross_encoder_reranking, curriculum_learning, dataset_generation, deep_q_networks, differentiable_optimization, differentiable_physics, direct_preference_optimization, distributionally_robust_optimization, diversity_aware_rank_based_sampling, dualreflect, dynamic_path_reconstruction, dynamic_supervised_fine_tuning_policy_optimization, dynamic_weight_adjustment, epsilon_greedy_search, error_driven_learning, evolutionary_algorithms, exact_linearization, exact_optimization, expert_in_the_loop, expert_prompting, few_shot_learning, fixed_point_relaxation, formal_verification, forward_generation, function_calling, gaussian_reparameterization, gdp_transformation, generative_process_supervision, global_constraints, global_local_search, gradient_descent, greedy_algorithm, greedy_decoding, greedy_search, heuristic_design, hierarchical_chunking, hierarchical_reinforcement_learning, hierarchical_retrieval_augmented_generation, human_llm_interaction, hyperparameter_optimization, intent_classification, iterative_adaptive_revision, l1_regularization, lagrangian_duality, linear_fractional_linearization, llm_as_optimizer, llm_as_semantic_generator, logsumexp_approximation, lookahead_mechanism, loop_based_structure_recovery, low_rank_adaptation, lower_bound_estimation, marge_loss, mdp_modeling, memory_driven_planning, metacognition, metadata_augmented_indexing, milp_reformulation, min_max_linearization, mixture_of_experts, model_data_separation, modeling_language, monotone_transformation_linearization, multimodal_ai, multimodal_llm, natural_language_generation, nonlinear_programming, online_scheduling, options_framework, ordered_eviction, pairwise_preference_model, pattern_detection, ppo, preference_learning, probabilistic_guarantee, problem_formulation, process_reward_model, progressive_specialization_training, propen, reflected_cot, reflexion, reinforce, reinforcement_learning_alignment, reinforcement_learning_with_verifiable_rewards, reverse_data_synthesis, reverse_engineering, reward_design, rl_ppo, rlhf, robust_optimization, rsome, rule_based_reformulation, sample_average_approximation, self_instruct, self_reflection, semantic_validation, semi_markov_decision_process, sibling_aware_expansion, simulation_environment, sparse_state_storage, stochastic_optimization, structure_aware_modeling, structured_output_parsing, symbolic_planning, temperature_sampling, textgrad, topological_sort, tree_of_thought, two_stage_retrieval, uncertainty_estimation, utpc_framework, virtual_reinforcement_learning, weighted_direct_preference_optimization, weighted_sum_method
*Shared methods:* chain_of_thought, constraint_programming, contrastive_learning, data_augmentation, data_synthesis, debugging, dynamic_programming, evolution_of_heuristics, funsearch, genetic_algorithm, gradient_based_optimization, group_relative_policy_optimization, grpo, in_context_learning, iterative_refinement, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, majority_voting, meta_optimization, milp_solver, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, neuro_symbolic_ai, neurosymbolic_ai, program_synthesis, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation, tool_use, tree_of_thoughts
...
### Front 2 (22 papers) — STABLE

**Density:** 0.31 | **Methods:** llm_in_the_loop, llm_code_generation, llm_as_evaluator, llm_as_heuristic, program_synthesis | **Problems:** linear_programming, optimization_modeling, mixed_integer_linear_programming, mixed_integer_programming, automated_optimization_modeling

*Unique methods:* ai_agents, anytime_algorithm, asymmetric_validation, auction_algorithm, automatic_symbolic_dualization, autonomous_coding_agents, bayesian_optimization, benchmark_creation, bipartite_graphs, bootstrapping, callbacks, canonical_graph_edit_distance, canonicalization, causal_discovery, closed_loop_control, code_interpreter_feedback, compiler_in_the_loop, data_cleaning, deterministic_parser, digital_replicas, dual_reward_system, empirical_study, ensemble_methods, error_analysis, evaluation_framework, execution_aware_modeling, graph_edit_distance, graph_isomorphism, graph_theory, gurobi, hashing, heuristic_filtering, hierarchical_decomposition, indicator_variables, instance_generation, irreducible_infeasible_subsystem_analysis, kahneman_tversky_optimization, lexicographical_optimization, literate_programming, llm_agents, llm_as_data_synthesizer, llm_as_meta_optimizer, llm_as_model_generator, llm_as_solver, llm_evaluation, llm_objective_formulation, makespan_minimization, mathematical_modeling, milp_general, minimum_bayes_risk_decoding, mixed_integer_programming, multi_agent_coordination, multi_armed_bandit, multi_robot_task_allocation, multi_turn_feedback, partial_kl_divergence, particle_swarm, piecewise_linear_constraints, pyscipopt, random_forest, reinforce_plus_plus, rejection_sampling, reverse_socratic_method, self_consistency, self_refinement, self_reflective_error_correction, sifting, simulation_optimization, smt_solvers, solver_in_the_loop, special_ordered_sets, star, structure_detection, symbolic_pruning, symmetric_decomposable_graphs, systematic_literature_review, test_time_adaptation, test_time_reinforcement_learning, test_time_scaling, tool_use_agents, two_stage_reward_system, uct, variable_fixing_heuristic, vector_embedding, weisfeiler_lehman_test
*Shared methods:* data_augmentation, data_synthesis, debugging, evolution_of_heuristics, expectation_maximization, genetic_algorithm, group_relative_policy_optimization, grpo, in_context_learning, instruction_tuning, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, majority_voting, meta_optimization, metaheuristics, milp_solver, mixed_integer_linear_programming, monte_carlo_tree_search, multi_agent_llm_system, multi_agent_system, program_synthesis, prompt_engineering, proximal_policy_optimization, reinforcement_learning, retrieval_augmented_generation, self_correction, self_improving_search, supervised_fine_tuning, supervised_learning, synthetic_data_generation
...
**Density:** 0.22 | **Methods:** llm_code_generation, llm_in_the_loop, llm_as_heuristic, program_synthesis, llm_as_evaluator | **Problems:** program_synthesis, scheduling, bin_packing, job_shop_scheduling, combinatorial_optimization

*Unique methods:* actor_critic, agentic_framework, aide, apollo_milp, attention_mechanism, automated_experimentation, behavioral_verification, bestofn_sampling, bi_gcn, black_box_optimization, branch_and_bound, centralized_training_decentralized_execution, chain_of_experts, clustergcn, compositional_prompting, conditional_flow_matching, constraint_programming_solver, cp_sat, cpmpy, crossover, cutting_planes, deep_reinforcement_learning, diagnosis_guided_repair, differential_attention, dirichlet_process_mixture_model, domain_specific_languages, eoh, evolutionary_algorithm, evolutionary_search, flow_matching, gat, gaussian_process, generative_models, graph_neural_networks, greedy_refinement, hyper_heuristics, iis_diagnostics, imitation_learning, ipython_kernel, iterative_correction, k_means_clustering, karp_reductions, knowledge_graphs, lagrangian_relaxation, large_language_models, llm_agent, llm_as_code_generator, llm_as_expert, mathematical_optimization, memory_compression, minizinc, minizinc_modeling, model_context_protocol, mstc_ahd, multi_agent_reinforcement_learning, multi_head_attention, mutation, mutation_testing, neural_diving, non_parametric_modeling, nsga_ii, optimization_model_validation, optimization_solver, parameter_efficient_fine_tuning, pmvb, predict_and_search, prioritized_experience_replay, pushdown_automaton, qlora, react_framework, reevo, reflection, reflection_mechanism, repeated_sampling, retrieval_augmented_in_context_learning, sac_opt, sampling_and_reweighting, self_verification, semantic_alignment, sensitivity_analysis, sentence_embedding, software_testing, solution_majority_voting, solver_based_perturbation, test_case_generation, tree_search, tri_gcn, vanilla_prompting, warm_starting, wasserstein_metric
*Shared methods:* chain_of_thought, constraint_programming, contrastive_learning, dynamic_programming, evolution_of_heuristics, expectation_maximization, funsearch, gradient_based_optimization, in_context_learning, instruction_tuning, iterative_refinement, linear_programming, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, llm_research_agent, metaheuristics, milp_solver, multi_agent_system, neuro_symbolic_ai, neurosymbolic_ai, program_synthesis, prompt_engineering, retrieval_augmented_generation, self_correction, supervised_fine_tuning, supervised_learning, tool_use, tree_of_thoughts
...
**TRUE SYNTHESIS** | score=0.83 | Front 0 → Front 2, Front 1
...
**TRUE SYNTHESIS** | score=0.82 | Front 1 → Front 2, Front 0
...
**TRUE SYNTHESIS** | score=0.82 | Front 0 → Front 2, Front 1
...
**TRUE SYNTHESIS** | score=0.80 | Front 1 → Front 2, Front 0
...
**TRUE SYNTHESIS** | score=0.78 | Front 1 → Front 2, Front 0
