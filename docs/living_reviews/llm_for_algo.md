...
**Density:** 0.29 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, evolution_of_heuristics, llm_as_heuristic | **Problems:** algorithm_discovery, heuristic_evolution, circle_packing, automated_algorithm_design, autocorrelation_inequalities
...
### Front 8 (12 papers) — EMERGING

**Density:** 0.76 | **Methods:** program_synthesis, llm_code_generation, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, tsp, operator_discovery, bin_packing, traveling_salesman_problem
...
### Front 1 (11 papers) — EMERGING

**Density:** 0.49 | **Methods:** llm_code_generation, program_synthesis, llm_as_heuristic, evolution_of_heuristics, llm_evolutionary_search | **Problems:** tsp, combinatorial_optimization, bin_packing, cvrp, heuristic_evolution
...
**Density:** 0.47 | **Methods:** llm_code_generation, llm_evolutionary_search, evolutionary_algorithm, llamea, genetic_programming | **Problems:** black_box_optimization, automated_algorithm_design, expensive_continuous_optimization, heuristic_evolution, operator_discovery
...
**TRUE SYNTHESIS** | score=0.68 | Front 1 → Front 8, Front 0
...
**TRUE SYNTHESIS** | score=0.67 | Front 5 → Front 8
...
**TRUE SYNTHESIS** | score=0.65 | Front 5 → Front 0, Front 8
...
**TRUE SYNTHESIS** | score=0.63 | Front 1 → Front 8, Front 2, Front 0, Front 5
