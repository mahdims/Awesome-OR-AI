...
### Front 1 (58 papers) — STABLE

**Density:** 0.06 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, operator_discovery, tsp, bin_packing, algorithm_discovery

*Unique methods:* a_star_search, abductive_reasoning, abstract_syntax_tree, acquisition_functions, activation_steering, actor_critic, adaptive_large_neighborhood_search, adaptive_operator_selection, adaptive_optimization, algorithm_analysis, algorithm_discovery, algorithm_distillation, algorithm_space_response_oracles, algorithmic_similarity_measurement, ant_colony_optimization, automated_heuristic_design, automated_testing, automatic_linearization, autoresearch, behavesim, best_fit_heuristic, best_response_oracle, bilevel_optimization, black_box_distillation, breadth_first_search, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, character_role_play, code_similarity_metrics, comparative_error_analysis, competitive_evaluation, concept_learning, continual_learning, contrastive_learning, convexification, cross_entropy_method, crossover, cumulative_diversity_index, data_rehearsal, decision_trees, deduplication, deep_focus_refinement, direct_preference_optimization, directed_acyclic_graph, distributed_computing, domain_specific_language, dpo, dynamic_analysis, dynamic_programming, dynamic_resource_allocation, dynamic_time_warping, edit_distance, elitist_strategy, elo_rating_system, embedding_based_similarity, empirical_evaluation, entailment_graph, euclidean_distance, eureka, evolution_of_thought, evolution_strategies, evoph, execution_guided_program_synthesis, execution_trace_based_similarity, exploitation_exploration_tradeoff, few_shot_learning, few_shot_prompting, fixed_point_iteration, game_theory, gaussian_processes, gepa, git_based_coordination, global_optimization, gnn, gridcoder, guided_local_search, harmony_search, heuristic_evolution, hgs, hierarchical_clustering, hill_climbing, human_in_the_loop, human_llm_collaboration, hybrid_search, id3_algorithm, iterative_repair, iterative_rounding, kalman_filter, knowledge_transfer, lago, language_hyper_heuristics, large_neighborhood_search, llm_as_environment_designer, llm_as_heuristic_generator, llm_as_meta_controller, llm_as_research_agent, llm_as_variation_operator, llm_guided_evolutionary_search, llm_proposal, llm_rl_trained, machine_unlearning, mamba, manual_refinement, maturity_aware_heuristic_critic, mcts, mdp_formulation, memetic_algorithm, memoization, meta_game, meta_gradients, meta_guidance, meta_optimization, meta_prompt_evolution, multi_agent_learning, multi_agent_llm, multi_agent_reasoning, multi_arm_bandit, multi_head_self_attention, multi_population_evolutionary_algorithm, multi_task_learning, mutation, nash_equilibrium, neural_architecture_search, neural_cellular_automata, neural_combinatorial_optimization, neural_operator, neural_program_synthesis, neural_unrolling, nonlinear_programming, nsga2, nucleus_sampling, one_plus_one_es, openevolve, pairwise_comparison, parameter_efficient_fine_tuning, pareto_dominance, pca, penalized_boltzmann_selection, perceiver_attention, performance_profiling, phylogenetic_graph, population_based_optimization, population_management, ppo, presolving, primal_heuristics, problem_solving_trajectory, procedural_generation, program_search, proximal_policy_optimization, psro, qube, race_detection, random_forest, ray_tracing, react_paradigm, receding_horizon_control, reflection, reflective_evolution, representation_engineering, representation_learning, reverse_engineering, reward_free_evolution, rl_dapo, rl_dpo, rl_trained, robophd, search_space_analysis, self_attention, self_consistency, self_instruction, self_instrumenting_agents, self_play, self_reflection, shannon_wiener_diversity_index, shinkaevolve, spatial_branch_and_bound, spea2, spectral_normalization, structure_based_similarity, supervised_fine_tuning, symbolic_distillation, template_based_parameter_optimization, test_time_fine_tuning, three_class_experience_replay, three_way_crossover, time_series_forecasting, token_based_similarity, trajectory_prediction, tree_search, tree_structured_parzen_estimator, trueskill_ranking, upper_confidence_bound, validation_free_evolution, version_control_system, zero_sum_game, zeroth_order_optimization
*Shared methods:* alphaevolve, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, data_augmentation, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, genetic_algorithm, genetic_programming, gradient_descent, greedy_algorithm, grpo, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, program_synthesis, prompt_engineering, quality_diversity, reevo, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, static_code_analysis, supervised_learning, transformer
...
### Front 0 (49 papers) — STABLE

**Density:** 0.06 | **Methods:** llm_code_generation, program_synthesis, evolution_of_heuristics, llm_evolutionary_search, llm_as_heuristic | **Problems:** heuristic_evolution, algorithm_discovery, automated_algorithm_design, black_box_optimization, circle_packing

*Unique methods:* abductive_reflection, abstract_syntax_tree_analysis, acquisition_function_design, active_learning, adam_optimizer, adaptive_boltzmann_selection, adaptive_iterated_local_search, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, adversarial_generation, agent_based_framework, agentic_ai, agentic_reinforcement_learning, algebraic_graph_construction, anisotropic_diffusion, ast_manipulation, autodiff, automated_algorithm_design, automated_evaluation, automatic_differentiation, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, barzilai_borwein, basin_hopping, batch_sampling, binary_search, binary_search_algorithm, branch_and_bound, butterworth_filter, cma_es, code_generation, code_validation, collaborative_tree_optimization, combinatorial_reasoning, compressed_watch_architecture, conflict_driven_clause_learning, convex_programming, counterfactual_regret_minimization, crossover_operators, cublas_epilogue, cuda_kernel_optimization, dag_execution, darwin_godel_machine, data_algorithm_co_evolution, data_diffusion, data_layout_optimization, deep_reinforcement_learning, derivative_free_optimization, differentiable_sampling, differential_evolution, discrete_transformer, diversity_metrics, diving_heuristics, dynamic_model_selection, embedding_similarity, ensemble_heuristics, entropic_objective, evo_mcts, evolutionary_strategy, execution_based_verification, expectation_maximization, explainable_ai, exploratory_landscape_analysis, exponential_moving_average, feature_fusion, fine_tuning, fireworks_algorithm, functional_disentanglement, gaussian_process, generative_agent_based_modeling, geometric_deep_learning, gigaevo, gpt_4o, gradient_based_optimization, gradient_correction, graph_algorithms, guided_filter, heuristic_analysis, huber_regularization, hybrid_evolutionary_memory, hydra_configuration, hypothesis_testing, image_quality_metrics, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_models, iterated_local_search, iterative_debugging, iterative_refinement, jax_framework, kd_tree, kernel_fusion, l_bfgs_b, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_summarizer, llm_driven_automatic_heuristic_design, llm_driven_optimization, llm_ensemble, llm_orchestration_router, llm_research_agent, local_refinement, local_verification_loop, lora_fine_tuning, magnitude_based_pruning, majority_voting, manifold_optimization, meta_agents, meta_evolution, meta_level_evolution, meta_prompting, mixed_integer_programming, mixed_precision_computing, monte_carlo_sampling, monte_carlo_simulation, multi_agent_simulation, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_uip_clause_learning, multilayer_perceptron, mutation_operators, negative_feedback_learning, neural_networks, novelty_search, numerical_linear_algebra, numerical_stability, numpy_library, on_policy_learning, open_ended_evolution, optimistic_regret_matching, optimization_algorithms, optimization_based_analyzers, path_credit_propagation, phase_unwrapping, piecewise_linear_encoding, plan_execute_summarize, polymorphic_execution_strategies, pre_training, preference_alignment, priority_function_design, program_evolution, progressive_disclosure, prompt_optimization, proximal_operators, puct_search, quasi_random_sampling, random_hill_climbing, reflective_code_synthesis, reward_design, reward_model, reward_shaping, rubric_reward, ruin_and_recreate, sat_solvers, selection_mechanisms, self_configuring_mas, self_generative_mas, self_improving_ai, self_rectifying_mas, semantic_delta, shap_analysis, shapely_library, sigmoid_calibration, slsqp, smt_solvers, sparse_solver, spectral_graph_theory, structural_variation, structure_tensor_analysis, surrogate_modeling, swarm_intelligence, symbolic_regression, symmetry_breaking_preprocessing, sympy_library, tabu_search, temperature_annealing, tensor_cores, test_time_learning, text_embeddings, theory_synthesis, tiling, tool_use, total_variation, tri_agent_architecture, truncated_svd, ucb, ucb1_bandit, ucb_selection, upper_confidence_bound_for_trees, value_scaled_optimization, vivification_sensitivity, wasserstein_distance, xgboost
*Shared methods:* alphaevolve, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, data_augmentation, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, genetic_algorithm, genetic_programming, gradient_descent, greedy_algorithm, grpo, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, program_synthesis, prompt_engineering, quality_diversity, reevo, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, static_code_analysis, supervised_learning, transformer
