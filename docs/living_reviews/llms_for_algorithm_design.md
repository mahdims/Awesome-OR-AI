...
*2 fronts detected — snapshot 2026-05-12*

### Front 1 (68 papers) — STABLE

**Density:** 0.03 | **Methods:** llm_code_generation, llm_evolutionary_search, program_synthesis, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, algorithm_discovery, combinatorial_optimization, circle_packing, operator_discovery

*Unique methods:* PCA, SVD, abductive_reflection, abstract_syntax_tree_analysis, acquisition_function_design, adam_optimizer, adaptive_boltzmann_selection, adaptive_iterated_local_search, adaptive_large_neighborhood_search, adaptive_operator_selection, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, agent_based_framework, agglomerative_clustering, algebraic_graph_construction, algorithm_discovery, anisotropic_diffusion, asynchronous_execution, autodiff, automated_evaluation, automated_testing, automatic_differentiation, autoresearch, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, barzilai_borwein, basin_hopping, batch_sampling, best_fit_heuristic, bi_dimensional_co_evolution, bi_level_optimization, binary_search, binary_search_algorithm, branch_and_bound, butterworth_filter, cma_es, code_generation, code_validation, combinatorial_reasoning, comparative_error_analysis, competitive_evaluation, compressed_watch_architecture, concept_learning, conflict_driven_clause_learning, continual_learning, contrastive_learning, convex_programming, cross_entropy_method, dag_execution, darwin_godel_machine, data_algorithm_co_evolution, data_diffusion, deep_focus_refinement, deep_reinforcement_learning, derivative_free_optimization, differentiable_sampling, directed_acyclic_graph, discrete_transformer, diving_heuristics, dynamic_programming, dynamic_resource_allocation, elo_rating_system, embedding_similarity, ensemble_heuristics, entropic_objective, eureka, evolutionary_strategy, execution_based_verification, expectation_maximization, explainable_ai, exponential_moving_average, fireworks_algorithm, functional_disentanglement, gaussian_process, gigaevo, gpt_4o, gradient_based_optimization, gradient_correction, graph_algorithms, graph_optimization, guided_filter, heuristic_analysis, hgs, huber_regularization, human_llm_collaboration, hybrid_evolutionary_memory, hybrid_search, hydra_configuration, hypothesis_testing, image_quality_metrics, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, inverse_density_sampling, island_based_evolutionary_algorithm, island_models, iterated_local_search, iterative_debugging, iterative_refinement, iterative_repair, iterative_rounding, jax_framework, kalman_filter, kd_tree, knowledge_transfer, l_bfgs_b, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_meta_controller, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_research_agent, llm_as_summarizer, llm_as_variation_operator, llm_driven_automatic_heuristic_design, llm_driven_optimization, llm_ensemble, llm_rl_trained, local_refinement, local_verification_loop, lora_fine_tuning, machine_unlearning, magnitude_based_pruning, majority_voting, manual_refinement, maturity_aware_heuristic_critic, mcts, mdp_formulation, memoization, meta_evolution, meta_guidance, meta_level_evolution, meta_prompting, meta_reinforcement_learning, metaheuristics, mixed_integer_programming, monte_carlo_simulation, multi_agent_reinforcement_learning, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_task_learning, multi_turn_reflection, multi_uip_clause_learning, multimodal_transformer, neural_cellular_automata, novelty_search, numerical_stability, numpy_library, open_ended_evolution, optimization_based_analyzers, penalized_boltzmann_selection, phase_unwrapping, piecewise_linear_encoding, plan_execute_summarize, polymorphic_execution_strategies, priority_function_design, procedural_generation, program_evolution, program_optimization, program_search, progressive_disclosure, prompt_optimization, proximal_operators, puct_search, qualitative_user_study, quasi_random_sampling, queue_management, random_hill_climbing, ray_tracing, react_paradigm, receding_horizon_control, reflective_learning, replicator_dynamics, reward_design, reward_model, rl_dapo, rl_dpo, robophd, ruin_and_recreate, sat_solvers, self_consistency, self_improving_ai, self_instrumenting_agents, semantic_delta, shap_analysis, shapely_library, shapley_values, sigmoid_calibration, slsqp, smt_solvers, sparse_solver, spectral_graph_theory, speculative_completion, staleness_handling, stochastic_approximation, structural_variation, structure_tensor_analysis, surrogate_modeling, swarm_intelligence, symbolic_regression, symmetry_breaking_preprocessing, sympy_library, tabu_search, temperature_annealing, test_time_learning, three_class_experience_replay, time_series_forecasting, tool_use, total_variation, trajectory_prediction, tree_structured_parzen_estimator, trueskill_ranking, truncated_svd, ucb1_bandit, ucb_selection, user_interface_design, validation_free_evolution, vivification_sensitivity, wasserstein_distance, xgboost, zeroth_order_optimization
*Shared methods:* RL_PPO, alphaevolve, ant_colony_optimization, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_descent, greedy_algorithm, grpo, guided_local_search, heuristic_evolution, human_in_the_loop, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, kernel_generation, large_language_models, large_neighborhood_search, learning_to_optimize, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_llm, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, openevolve, policy_space_response_oracles, population_based_optimization, program_synthesis, prompt_engineering, quality_diversity, random_forest, reevo, reflection, reinforcement_learning, retrieval_augmented_generation, reward_shaping, self_improving_search, simulated_annealing, static_code_analysis, supervised_learning, tool_augmented_llm, transformer, upper_confidence_bound
...
**Density:** 0.05 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, operator_discovery, tsp, automated_algorithm_design, bin_packing

*Unique methods:* ALNS, BM25, a_star_search, abductive_reasoning, abstract_syntax_tree, abstract_syntax_trees, acquisition_functions, activation_steering, active_learning, actor_critic, adversarial_generation, agentic_ai, agentic_reinforcement_learning, algorithm_analysis, algorithm_distillation, algorithm_space_response_oracles, algorithmic_similarity_measurement, ast_manipulation, auto_tuning, automated_algorithm_design, automated_heuristic_design, automatic_linearization, behavesim, best_response_oracle, bilevel_optimization, black_box_distillation, breadth_first_search, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, character_role_play, code_similarity_metrics, collaborative_tree_optimization, confidence_interval_based_certification, convexification, counterfactual_regret_minimization, crossover, crossover_operators, cublas_epilogue, cuda_kernel_optimization, cumulative_diversity_index, cvt_map_elites, data_augmentation, data_layout_optimization, data_rehearsal, decision_trees, deduplication, differential_evolution, direct_preference_optimization, distributed_computing, diversity_metrics, domain_specific_language, dpo, dynamic_analysis, dynamic_model_selection, dynamic_time_warping, edit_distance, elitist_strategy, elo_rating, embedding_based_similarity, empirical_evaluation, entailment_graph, euclidean_distance, evo_mcts, evolution_of_thought, evolution_strategies, evoph, execution_guided_program_synthesis, execution_trace_based_similarity, exploitation_exploration_tradeoff, feature_fusion, few_shot_learning, few_shot_prompting, fine_tuning, fixed_point_iteration, game_theory, gaussian_processes, generative_agent_based_modeling, geometric_deep_learning, git_based_coordination, global_optimization, gnn, gradient_free_learning, gridcoder, harmony_search, hierarchical_clustering, hill_climbing, id3_algorithm, k_means, kernel_fusion, lago, language_hyper_heuristics, llm_as_environment_designer, llm_as_heuristic_generator, llm_guided_evolutionary_search, llm_orchestration_router, llm_proposal, mamba, manifold_optimization, memetic_algorithm, meta_agents, meta_game, meta_gradients, meta_optimization, meta_prompt_evolution, mixed_precision_computing, monte_carlo_sampling, multi_agent_learning, multi_agent_reasoning, multi_agent_simulation, multi_arm_bandit, multi_head_self_attention, multi_population_evolutionary_algorithm, multilayer_perceptron, mutation, mutation_operators, nash_equilibrium, negative_feedback_learning, neural_architecture_search, neural_combinatorial_optimization, neural_networks, neural_operator, neural_program_synthesis, neural_unrolling, nonlinear_programming, nsga2, nucleus_sampling, numerical_linear_algebra, on_policy_learning, one_plus_one_es, optimistic_regret_matching, optimization_algorithms, pairwise_comparison, parameter_efficient_fine_tuning, pareto_dominance, path_credit_propagation, pca, perceiver_attention, performance_profiling, phylogenetic_graph, population_management, ppo, pre_training, preference_alignment, presolving, primal_heuristics, problem_solving_trajectory, proximal_policy_optimization, psro, qube, race_detection, reflective_code_synthesis, reflective_evolution, representation_engineering, representation_learning, reverse_engineering, reward_free_evolution, rl_trained, rubric_reward, search_space_analysis, selection_mechanisms, self_attention, self_configuring_mas, self_generative_mas, self_instruction, self_play, self_rectifying_mas, self_reflection, shannon_wiener_diversity_index, shinkaevolve, spatial_branch_and_bound, spea2, spectral_normalization, structure_based_similarity, supervised_fine_tuning, surrogate_model_optimization, symbolic_distillation, template_based_parameter_optimization, tensor_cores, test_time_fine_tuning, text_embeddings, theory_synthesis, three_way_crossover, tiling, token_based_similarity, tree_search, tree_structured_search, tri_agent_architecture, ucb, upper_confidence_bound_for_trees, value_scaled_optimization, version_control_system, zero_sum_game
*Shared methods:* RL_PPO, alphaevolve, ant_colony_optimization, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_descent, greedy_algorithm, grpo, guided_local_search, heuristic_evolution, human_in_the_loop, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, kernel_generation, large_language_models, large_neighborhood_search, learning_to_optimize, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_llm, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, openevolve, policy_space_response_oracles, population_based_optimization, program_synthesis, prompt_engineering, quality_diversity, random_forest, reevo, reflection, reinforcement_learning, retrieval_augmented_generation, reward_shaping, self_improving_search, simulated_annealing, static_code_analysis, supervised_learning, tool_augmented_llm, transformer, upper_confidence_bound
