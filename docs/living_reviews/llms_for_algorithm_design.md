...
### Front 0 (66 papers) — STABLE

**Density:** 0.05 | **Methods:** llm_evolutionary_search, llm_code_generation, program_synthesis, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, operator_discovery, tsp, traveling_salesman_problem, bin_packing

*Unique methods:* ALNS, GRPO, PCA, SVD, a_star_search, abductive_reasoning, abstract_syntax_tree, abstract_syntax_tree_analysis, abstract_syntax_trees, acquisition_functions, active_learning, actor_critic, adaptive_operator_selection, adversarial_generation, algorithm_analysis, algorithm_distillation, algorithm_space_response_oracles, anisotropic_diffusion, ast_manipulation, asynchronous_execution, automated_algorithm_design, automated_testing, autoresearch, barzilai_borwein, best_response_oracle, bi_level_optimization, bilevel_optimization, black_box_distillation, breadth_first_search, butterworth_filter, causal_discovery, causal_inference, character_role_play, code_validation, collaborative_tree_optimization, comparative_error_analysis, competitive_evaluation, confidence_interval_based_certification, counterfactual_regret_minimization, cumulative_diversity_index, data_algorithm_co_evolution, deduplication, deep_focus_refinement, differential_evolution, distributed_computing, diversity_metrics, diving_heuristics, domain_specific_language, dpo, dynamic_model_selection, elitist_strategy, elo_rating, elo_rating_system, empirical_evaluation, eureka, evo_mcts, evolution_of_thought, evolution_strategies, evolutionary_strategy, evoph, execution_guided_program_synthesis, explainable_ai, exploitation_exploration_tradeoff, feature_fusion, few_shot_learning, few_shot_prompting, fine_tuning, fixed_point_iteration, game_theory, gaussian_processes, generative_agent_based_modeling, gnn, graph_grounded_optimization, graph_optimization, gridcoder, guided_filter, harmony_search, huber_regularization, image_quality_metrics, integer_programming, inverse_density_sampling, iterative_repair, kalman_filter, knowledge_transfer, language_hyper_heuristics, llm_as_environment_designer, llm_as_heuristic_generator, llm_as_meta_controller, llm_guided_evolutionary_search, llm_orchestration_router, llm_proposal, mamba, maturity_aware_heuristic_critic, memetic_algorithm, memory_management, meta_agents, meta_game, meta_gradients, meta_optimization, meta_prompt_evolution, meta_reinforcement_learning, monte_carlo_sampling, multi_agent_learning, multi_agent_simulation, multi_agent_systems, multi_arm_bandit, multi_head_self_attention, multi_population_evolutionary_algorithm, multi_task_learning, multi_view_retrieval, multilayer_perceptron, multimodal_transformer, nash_equilibrium, negative_feedback_learning, neural_architecture_search, neural_combinatorial_optimization, neural_networks, neural_operator, neural_program_synthesis, neural_unrolling, nsga2, on_policy_learning, one_plus_one_es, optimistic_regret_matching, pareto_dominance, path_credit_propagation, penalized_boltzmann_selection, perceiver_attention, phase_unwrapping, population_based_optimization, ppo, pre_training, preference_alignment, program_optimization, proximal_operators, proximal_policy_optimization, psro, qualitative_user_study, qube, queue_management, rao_family_metaheuristics, ray_tracing, react_paradigm, receding_horizon_control, reflective_code_synthesis, reflective_evolution, replicator_dynamics, rl_trained, robophd, score_fusion, search_space_analysis, self_attention, self_configuring_mas, self_consistency, self_generative_mas, self_instrumenting_agents, self_rectifying_mas, self_reflection, shannon_wiener_diversity_index, shap_analysis, shinkaevolve, spea2, spectral_normalization, speculative_completion, staleness_handling, static_code_analysis, stochastic_approximation, structure_tensor_analysis, surrogate_model_optimization, surrogate_modeling, symbolic_distillation, template_based_parameter_optimization, test_time_fine_tuning, text_embeddings, three_class_experience_replay, total_variation, tree_search, tree_structured_search, tri_agent_architecture, trueskill_ranking, ucb, user_interface_design, validation_free_evolution, value_scaled_optimization, xgboost, zero_sum_game
*Shared methods:* RL_PPO, adam_optimizer, alphaevolve, ant_colony_optimization, auto_tuning, bayesian_optimization, black_box_optimization, branch_and_bound, chain_of_thought, co_evolution, code_embedding, crossover, cvt_map_elites, data_augmentation, direct_preference_optimization, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_descent, greedy_algorithm, grpo, guided_local_search, heuristic_evolution, hill_climbing, human_in_the_loop, hyper_heuristics, in_context_learning, island_model, island_model_ea, kernel_generation, large_language_models, learning_to_optimize, linear_programming, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_llm, multi_agent_system, multi_armed_bandit, multi_objective_optimization, mutation, offline_reinforcement_learning, openevolve, policy_space_response_oracles, population_management, program_synthesis, prompt_engineering, quality_diversity, reevo, reflection, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, supervised_fine_tuning, supervised_learning, tool_augmented_llm, transformer, upper_confidence_bound
...
### Front 1 (54 papers) — DECLINING

**Density:** 0.05 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, algorithm_discovery, circle_packing, combinatorial_optimization, automated_algorithm_design

*Unique methods:* abductive_reflection, acquisition_function_design, adaptive_boltzmann_selection, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, agent_based_framework, agentic_reinforcement_learning, agglomerative_clustering, algebraic_graph_construction, automated_evaluation, automated_heuristic_design, automatic_differentiation, automatic_linearization, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, basin_hopping, batch_sampling, binary_search, binary_search_algorithm, catastrophic_forgetting_mitigation, cma_es, code_generation, coding_agents, combinatorial_reasoning, compressed_watch_architecture, compute_graph_optimization, concept_learning, conflict_driven_clause_learning, contrastive_learning, convex_programming, convexification, counterexample_guided_inductive_synthesis, cross_entropy_method, cublas_epilogue, cuda_kernel_optimization, dag_execution, darwin_godel_machine, data_diffusion, data_layout_optimization, data_rehearsal, decision_trees, deep_reinforcement_learning, depth_first_search, directed_acyclic_graph, dynamic_analysis, dynamic_resource_allocation, embedding_similarity, ensemble_heuristics, entailment_graph, entropic_objective, evaluation_hack_detection, execution_based_verification, expectation_maximization, exponential_moving_average, fireworks_algorithm, gaussian_process, gigaevo, git_based_coordination, git_worktree_isolation, global_optimization, gradient_correction, gradient_free_learning, graph_algorithms, heuristic_analysis, hgs, hybrid_evolutionary_memory, hybrid_search, hydra_configuration, id3_algorithm, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_models, iterative_debugging, iterative_refinement, jax_framework, k_means, kd_tree, kernel_fusion, l_bfgs_b, lago, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_summarizer, llm_ensemble, llm_in_context_learning, llm_rl_trained, local_verification_loop, lora_fine_tuning, majority_voting, mcts, mdp_formulation, memoization, meta_guidance, meta_level_evolution, meta_prompting, mixed_integer_programming, mixed_precision_computing, monte_carlo_simulation, multi_agent_reasoning, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_turn_reflection, multi_uip_clause_learning, nonlinear_programming, novelty_search, nucleus_sampling, numerical_stability, numpy_library, open_ended_evolution, optimization_based_analyzers, pairwise_comparison, parameter_efficient_fine_tuning, performance_profiling, phylogenetic_graph, plan_execute_summarize, polymorphic_execution_strategies, presolving, primal_heuristics, priority_function_design, program_evolution, progressive_disclosure, prompt_optimization, puct_search, quality_diversity_search, quasi_random_sampling, race_detection, random_forest, random_hill_climbing, representation_learning, reward_design, reward_free_evolution, reward_model, reward_shaping, rl_dapo, rubric_reward, sat_solvers, self_improving_ai, self_instruction, semantic_delta, shapely_library, shapley_values, sigmoid_calibration, slsqp, smt_solvers, sparse_solver, spatial_branch_and_bound, spectral_graph_theory, swarm_intelligence, symmetry_breaking_preprocessing, sympy_library, tabu_search, tensor_cores, test_time_learning, three_way_crossover, tiling, tool_use, tree_structured_parzen_estimator, truncated_svd, upper_confidence_bound_for_trees, version_control_system, vivification_sensitivity, wasserstein_distance, zeroth_order_optimization
*Shared methods:* RL_PPO, adam_optimizer, alphaevolve, auto_tuning, bayesian_optimization, black_box_optimization, branch_and_bound, chain_of_thought, code_embedding, crossover, cvt_map_elites, data_augmentation, direct_preference_optimization, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, heuristic_evolution, hill_climbing, human_in_the_loop, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, kernel_generation, large_language_models, large_neighborhood_search, linear_programming, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_llm, multi_agent_reinforcement_learning, multi_agent_system, multi_armed_bandit, multi_objective_optimization, mutation, openevolve, policy_space_response_oracles, population_management, program_synthesis, prompt_engineering, quality_diversity, reevo, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, supervised_fine_tuning, supervised_learning, tool_augmented_llm, upper_confidence_bound
...
### Front 2 (20 papers) — EMERGING

**Density:** 0.02 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, automated_algorithm_design, bin_packing, algorithm_discovery, operator_discovery

*Unique methods:* BM25, activation_steering, adaptive_iterated_local_search, adaptive_large_neighborhood_search, agentic_ai, algorithm_discovery, algorithmic_similarity_measurement, autodiff, behavesim, best_fit_heuristic, bi_dimensional_co_evolution, code_similarity_metrics, continual_learning, crossover_operators, derivative_free_optimization, differentiable_sampling, discrete_transformer, dynamic_programming, dynamic_time_warping, edit_distance, embedding_based_similarity, euclidean_distance, execution_trace_based_similarity, framework_design, functional_disentanglement, geometric_deep_learning, gpt_4o, hierarchical_clustering, human_llm_collaboration, hypothesis_testing, iterated_local_search, iterative_rounding, llm_as_research_agent, llm_as_variation_operator, llm_driven_automatic_heuristic_design, llm_driven_optimization, local_refinement, machine_unlearning, magnitude_based_pruning, manifold_optimization, manual_refinement, meta_editing, meta_evolution, mutation_operators, neural_cellular_automata, numerical_linear_algebra, optimization_algorithms, pca, piecewise_linear_encoding, problem_solving_trajectory, procedural_generation, program_search, reflective_learning, representation_engineering, reverse_engineering, rl_dpo, ruin_and_recreate, selection_mechanisms, self_play, structural_variation, structure_based_similarity, symbolic_regression, temperature_annealing, theory_synthesis, time_series_forecasting, token_based_similarity, trajectory_prediction, ucb1_bandit, ucb_selection
*Shared methods:* RL_PPO, alphaevolve, ant_colony_optimization, bayesian_optimization, chain_of_thought, co_evolution, eoh, evolution_of_heuristics, evolutionary_algorithm, evolutionary_computation, evolutionary_search, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, guided_local_search, in_context_learning, island_evolution, island_model, large_neighborhood_search, learning_to_optimize, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, multi_agent_reinforcement_learning, multi_agent_system, multi_objective_optimization, offline_reinforcement_learning, program_synthesis, reevo, reflection, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, supervised_learning, tool_augmented_llm, transformer
...
**TRUE SYNTHESIS** | score=0.63 | Front 1 → Front 2, Front 0
