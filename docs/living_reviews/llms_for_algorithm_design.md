...
*2 fronts detected — snapshot 2026-05-05*

### Front 1 (61 papers) — STABLE

**Density:** 0.04 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, algorithm_discovery, combinatorial_optimization, automated_algorithm_design, circle_packing

*Unique methods:* a_star_search, abductive_reasoning, abductive_reflection, abstract_syntax_trees, activation_steering, adaptive_boltzmann_selection, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, agent_based_framework, agentic_ai, agentic_reinforcement_learning, algebraic_graph_construction, algorithm_discovery, algorithm_space_response_oracles, anisotropic_diffusion, auto_tuning, autodiff, automated_evaluation, automated_heuristic_design, automatic_differentiation, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, barzilai_borwein, batch_sampling, best_response_oracle, bi_level_optimization, binary_search, binary_search_algorithm, branch_and_bound, breadth_first_search, butterworth_filter, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, cma_es, code_generation, code_validation, combinatorial_reasoning, compressed_watch_architecture, conflict_driven_clause_learning, continual_learning, convex_programming, crossover, crossover_operators, cublas_epilogue, cuda_kernel_optimization, dag_execution, darwin_godel_machine, data_algorithm_co_evolution, data_diffusion, data_layout_optimization, data_rehearsal, derivative_free_optimization, differentiable_sampling, directed_acyclic_graph, discrete_transformer, diving_heuristics, domain_specific_language, dynamic_analysis, dynamic_resource_allocation, embedding_similarity, empirical_evaluation, ensemble_heuristics, entropic_objective, evo_mcts, execution_based_verification, execution_guided_program_synthesis, expectation_maximization, exponential_moving_average, fireworks_algorithm, functional_disentanglement, game_theory, geometric_deep_learning, git_based_coordination, gradient_correction, gradient_free_learning, graph_algorithms, graph_optimization, gridcoder, guided_filter, heuristic_analysis, huber_regularization, human_in_the_loop, hybrid_evolutionary_memory, hydra_configuration, hypothesis_testing, image_quality_metrics, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_evolution, island_models, iterative_debugging, jax_framework, k_means, kalman_filter, kd_tree, kernel_fusion, lago, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_aggregator, llm_as_environment_designer, llm_as_evolver, llm_as_executor, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_research_agent, llm_as_summarizer, llm_driven_optimization, llm_ensemble, llm_iterative_refinement, llm_research_agent, local_refinement, local_verification_loop, lora_fine_tuning, machine_unlearning, magnitude_based_pruning, majority_voting, manifold_optimization, maturity_aware_heuristic_critic, memoization, meta_evolution, meta_game, meta_guidance, meta_level_evolution, meta_prompting, metaheuristics, mixed_integer_programming, mixed_precision_computing, monte_carlo_simulation, multi_agent_learning, multi_agent_llm, multi_arm_bandit, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_uip_clause_learning, multilayer_perceptron, mutation, mutation_operators, nash_equilibrium, neural_cellular_automata, neural_program_synthesis, novelty_search, nucleus_sampling, numerical_linear_algebra, numerical_stability, numpy_library, open_ended_evolution, openevolve, optimization_algorithms, optimization_based_analyzers, pairwise_comparison, parameter_efficient_fine_tuning, pca, penalized_boltzmann_selection, performance_profiling, phase_unwrapping, phylogenetic_graph, piecewise_linear_encoding, plan_execute_summarize, polymorphic_execution_strategies, priority_function_design, procedural_generation, program_evolution, program_optimization, progressive_disclosure, prompt_optimization, proximal_operators, psro, puct_search, quasi_random_sampling, race_detection, random_hill_climbing, ray_tracing, react_paradigm, reflective_code_synthesis, representation_engineering, reverse_engineering, reward_design, reward_free_evolution, reward_model, rl_dpo, rubric_reward, sat_solvers, selection_mechanisms, self_consistency, self_improving_ai, self_instruction, self_play, semantic_delta, shapely_library, shinkaevolve, sigmoid_calibration, smt_solvers, sparse_solver, spectral_graph_theory, structural_variation, structure_tensor_analysis, swarm_intelligence, symbolic_regression, symmetry_breaking_preprocessing, sympy_library, tabu_search, temperature_annealing, tensor_cores, test_time_fine_tuning, test_time_learning, theory_synthesis, three_class_experience_replay, three_way_crossover, tiling, time_series_forecasting, tool_use, total_variation, trajectory_prediction, tree_search, truncated_svd, ucb1_bandit, ucb_selection, version_control_system, vivification_sensitivity, wasserstein_distance, zero_sum_game, zeroth_order_optimization
*Shared methods:* adam_optimizer, alphaevolve, bayesian_optimization, black_box_optimization, co_evolution, code_embedding, data_augmentation, direct_preference_optimization, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, hyper_heuristics, in_context_learning, island_model, island_model_ea, kernel_generation, large_language_models, large_neighborhood_search, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, program_synthesis, prompt_engineering, quality_diversity, reinforcement_learning, retrieval_augmented_generation, reward_shaping, self_improving_search, simulated_annealing, slsqp, supervised_fine_tuning, supervised_learning, transformer, upper_confidence_bound
...
### Front 0 (60 papers) — STABLE

**Density:** 0.06 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, tsp, operator_discovery, bin_packing, black_box_optimization

*Unique methods:* PCA, RL_PPO, SVD, abstract_syntax_tree, abstract_syntax_tree_analysis, acquisition_function_design, acquisition_functions, active_learning, actor_critic, adaptive_iterated_local_search, adaptive_large_neighborhood_search, adaptive_operator_selection, adversarial_generation, agglomerative_clustering, algorithm_analysis, algorithm_distillation, algorithmic_similarity_measurement, ant_colony_optimization, ast_manipulation, automated_algorithm_design, automated_testing, automatic_linearization, autoresearch, basin_hopping, behavesim, best_fit_heuristic, bi_dimensional_co_evolution, bilevel_optimization, black_box_distillation, chain_of_thought, character_role_play, code_similarity_metrics, collaborative_tree_optimization, comparative_error_analysis, competitive_evaluation, concept_learning, confidence_interval_based_certification, contrastive_learning, convexification, counterfactual_regret_minimization, cross_entropy_method, cumulative_diversity_index, decision_trees, deduplication, deep_focus_refinement, deep_reinforcement_learning, differential_evolution, distributed_computing, diversity_metrics, dpo, dynamic_model_selection, dynamic_programming, dynamic_time_warping, edit_distance, elitist_strategy, elo_rating_system, embedding_based_similarity, entailment_graph, eoh, euclidean_distance, eureka, evolution_of_thought, evolution_strategies, evolutionary_strategy, evoph, execution_trace_based_similarity, explainable_ai, exploitation_exploration_tradeoff, feature_fusion, few_shot_learning, few_shot_prompting, fine_tuning, fixed_point_iteration, gaussian_process, gaussian_processes, generative_agent_based_modeling, gigaevo, global_optimization, gnn, gpt_4o, guided_local_search, harmony_search, heuristic_evolution, hgs, hierarchical_clustering, hill_climbing, human_llm_collaboration, hybrid_search, id3_algorithm, inverse_density_sampling, iterated_local_search, iterative_refinement, iterative_repair, iterative_rounding, knowledge_transfer, l_bfgs_b, language_hyper_heuristics, llm_as_agent, llm_as_heuristic_generator, llm_as_meta_controller, llm_as_variation_operator, llm_driven_automatic_heuristic_design, llm_guided_evolutionary_search, llm_in_context_learning, llm_orchestration_router, llm_proposal, llm_rl_trained, mamba, manual_refinement, mcts, mdp_formulation, memetic_algorithm, meta_agents, meta_gradients, meta_optimization, meta_prompt_evolution, monte_carlo_sampling, multi_agent_reasoning, multi_agent_simulation, multi_head_self_attention, multi_population_evolutionary_algorithm, multi_task_learning, multi_turn_reflection, multimodal_transformer, negative_feedback_learning, neural_architecture_search, neural_combinatorial_optimization, neural_networks, neural_operator, neural_unrolling, nonlinear_programming, nsga2, on_policy_learning, one_plus_one_es, optimistic_regret_matching, pareto_dominance, path_credit_propagation, perceiver_attention, population_based_optimization, population_management, ppo, pre_training, preference_alignment, presolving, primal_heuristics, problem_solving_trajectory, program_search, proximal_policy_optimization, qube, random_forest, receding_horizon_control, reevo, reflection, reflective_evolution, reflective_learning, representation_learning, rl_dapo, rl_trained, robophd, ruin_and_recreate, search_space_analysis, self_attention, self_configuring_mas, self_generative_mas, self_instrumenting_agents, self_rectifying_mas, self_reflection, shannon_wiener_diversity_index, shap_analysis, spatial_branch_and_bound, spea2, spectral_normalization, static_code_analysis, structure_based_similarity, surrogate_modeling, symbolic_distillation, template_based_parameter_optimization, text_embeddings, token_based_similarity, tool_augmented_llm, tree_structured_parzen_estimator, tree_structured_search, tri_agent_architecture, trueskill_ranking, ucb, upper_confidence_bound_for_trees, validation_free_evolution, value_scaled_optimization, xgboost
*Shared methods:* adam_optimizer, alphaevolve, bayesian_optimization, black_box_optimization, co_evolution, code_embedding, data_augmentation, direct_preference_optimization, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, hyper_heuristics, in_context_learning, island_model, island_model_ea, kernel_generation, large_language_models, large_neighborhood_search, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, program_synthesis, prompt_engineering, quality_diversity, reinforcement_learning, retrieval_augmented_generation, reward_shaping, self_improving_search, simulated_annealing, slsqp, supervised_fine_tuning, supervised_learning, transformer, upper_confidence_bound
...
**TRUE SYNTHESIS** | score=0.63 | Front 1 → Front 0
