...
*2 fronts detected — snapshot 2026-04-07*

### Front 0 (57 papers) — STABLE

**Density:** 0.04 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, algorithm_discovery, circle_packing, combinatorial_optimization, automated_algorithm_design

*Unique methods:* abductive_reasoning, abductive_reflection, activation_steering, adaptive_boltzmann_selection, adaptive_iterated_local_search, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, agent_based_framework, agentic_ai, algebraic_graph_construction, algorithm_discovery, algorithm_space_response_oracles, algorithmic_similarity_measurement, automated_evaluation, automatic_differentiation, automatic_linearization, autoresearch, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, basin_hopping, batch_sampling, behavesim, best_fit_heuristic, best_response_oracle, binary_search, binary_search_algorithm, branch_and_bound, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, cma_es, code_generation, code_similarity_metrics, collaborative_tree_optimization, combinatorial_reasoning, comparative_error_analysis, compressed_watch_architecture, concept_learning, conflict_driven_clause_learning, continual_learning, contrastive_learning, convex_programming, convexification, counterfactual_regret_minimization, cross_entropy_method, crossover_operators, dag_execution, darwin_godel_machine, data_algorithm_co_evolution, data_diffusion, data_rehearsal, deep_focus_refinement, deep_reinforcement_learning, differentiable_sampling, discrete_transformer, distributed_computing, diving_heuristics, dynamic_programming, dynamic_resource_allocation, dynamic_time_warping, edit_distance, elo_rating_system, embedding_based_similarity, embedding_similarity, ensemble_heuristics, entailment_graph, entropic_objective, eoh, euclidean_distance, eureka, evo_mcts, execution_based_verification, execution_trace_based_similarity, expectation_maximization, exploratory_landscape_analysis, exponential_moving_average, fireworks_algorithm, functional_disentanglement, geometric_deep_learning, gigaevo, global_optimization, gpt_4o, gradient_correction, graph_algorithms, heuristic_analysis, hierarchical_clustering, human_llm_collaboration, hybrid_evolutionary_memory, hybrid_search, hydra_configuration, hypothesis_testing, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_models, iterated_local_search, iterative_debugging, iterative_refinement, iterative_rounding, jax_framework, kalman_filter, kd_tree, knowledge_transfer, l_bfgs_b, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_research_agent, llm_as_summarizer, llm_driven_automatic_heuristic_design, llm_driven_optimization, llm_ensemble, llm_research_agent, local_refinement, local_verification_loop, lora_fine_tuning, machine_unlearning, magnitude_based_pruning, majority_voting, manifold_optimization, manual_refinement, maturity_aware_heuristic_critic, mcts, mdp_formulation, meta_agents, meta_evolution, meta_game, meta_guidance, meta_level_evolution, meta_prompt_evolution, meta_prompting, mixed_integer_programming, monte_carlo_simulation, multi_agent_reasoning, multi_agent_reinforcement_learning, multi_arm_bandit, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_task_learning, multi_uip_clause_learning, mutation_operators, neural_cellular_automata, nonlinear_programming, novelty_search, nucleus_sampling, numerical_linear_algebra, numerical_stability, numpy_library, offline_reinforcement_learning, open_ended_evolution, optimistic_regret_matching, optimization_algorithms, optimization_based_analyzers, parameter_efficient_fine_tuning, path_credit_propagation, pca, penalized_boltzmann_selection, piecewise_linear_encoding, plan_execute_summarize, policy_space_response_oracles, polymorphic_execution_strategies, preference_alignment, presolving, primal_heuristics, priority_function_design, problem_solving_trajectory, procedural_generation, program_evolution, program_search, progressive_disclosure, prompt_optimization, puct_search, quasi_random_sampling, random_hill_climbing, ray_tracing, react_paradigm, reflective_code_synthesis, representation_engineering, reverse_engineering, reward_design, reward_model, rl_dpo, robophd, ruin_and_recreate, sat_solvers, selection_mechanisms, self_configuring_mas, self_consistency, self_generative_mas, self_improving_ai, self_instruction, self_instrumenting_agents, self_play, self_rectifying_mas, semantic_delta, shapely_library, sigmoid_calibration, slsqp, smt_solvers, sparse_solver, spatial_branch_and_bound, spectral_graph_theory, structural_variation, structure_based_similarity, swarm_intelligence, symbolic_regression, symmetry_breaking_preprocessing, sympy_library, tabu_search, temperature_annealing, template_based_parameter_optimization, test_time_learning, theory_synthesis, three_class_experience_replay, time_series_forecasting, token_based_similarity, tool_use, trajectory_prediction, tree_structured_parzen_estimator, tri_agent_architecture, truncated_svd, ucb_selection, validation_free_evolution, value_scaled_optimization, vivification_sensitivity, wasserstein_distance, zeroth_order_optimization
*Shared methods:* alphaevolve, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, data_augmentation, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, game_theory, genetic_algorithm, genetic_programming, gepa, gradient_descent, greedy_algorithm, grpo, heuristic_evolution, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, population_based_optimization, population_management, program_synthesis, prompt_engineering, quality_diversity, reevo, reinforcement_learning, retrieval_augmented_generation, reward_shaping, self_improving_search, shinkaevolve, simulated_annealing, static_code_analysis, supervised_fine_tuning, supervised_learning, transformer, upper_confidence_bound, zero_sum_game
...
### Front 1 (50 papers) — STABLE

**Density:** 0.08 | **Methods:** llm_code_generation, program_synthesis, llm_as_heuristic, llm_evolutionary_search, evolution_of_heuristics | **Problems:** heuristic_evolution, operator_discovery, bin_packing, tsp, black_box_optimization

*Unique methods:* a_star_search, abstract_syntax_tree, abstract_syntax_tree_analysis, acquisition_function_design, acquisition_functions, active_learning, actor_critic, adam_optimizer, adaptive_large_neighborhood_search, adaptive_operator_selection, adversarial_generation, agentic_reinforcement_learning, algorithm_analysis, algorithm_distillation, anisotropic_diffusion, ant_colony_optimization, ast_manipulation, autodiff, automated_algorithm_design, automated_heuristic_design, automated_testing, barzilai_borwein, bilevel_optimization, black_box_distillation, breadth_first_search, butterworth_filter, character_role_play, code_validation, competitive_evaluation, crossover, cublas_epilogue, cuda_kernel_optimization, cumulative_diversity_index, data_layout_optimization, decision_trees, deduplication, derivative_free_optimization, differential_evolution, direct_preference_optimization, directed_acyclic_graph, diversity_metrics, domain_specific_language, dpo, dynamic_analysis, dynamic_model_selection, elitist_strategy, empirical_evaluation, evolution_of_thought, evolution_strategies, evolutionary_strategy, evoph, execution_guided_program_synthesis, explainable_ai, exploitation_exploration_tradeoff, feature_fusion, few_shot_learning, few_shot_prompting, fine_tuning, fixed_point_iteration, gaussian_process, gaussian_processes, generative_agent_based_modeling, git_based_coordination, gnn, gradient_based_optimization, gridcoder, guided_filter, guided_local_search, harmony_search, hgs, hill_climbing, huber_regularization, human_in_the_loop, id3_algorithm, image_quality_metrics, iterative_repair, kernel_fusion, lago, language_hyper_heuristics, large_neighborhood_search, llm_as_agent, llm_as_environment_designer, llm_as_heuristic_generator, llm_as_meta_controller, llm_as_variation_operator, llm_guided_evolutionary_search, llm_in_context_learning, llm_orchestration_router, llm_proposal, llm_rl_trained, mamba, memetic_algorithm, memoization, meta_gradients, meta_optimization, mixed_precision_computing, monte_carlo_sampling, multi_agent_learning, multi_agent_llm, multi_agent_simulation, multi_head_self_attention, multi_population_evolutionary_algorithm, multilayer_perceptron, mutation, nash_equilibrium, negative_feedback_learning, neural_architecture_search, neural_combinatorial_optimization, neural_networks, neural_operator, neural_program_synthesis, neural_unrolling, nsga2, on_policy_learning, one_plus_one_es, openevolve, pairwise_comparison, pareto_dominance, perceiver_attention, performance_profiling, phase_unwrapping, phylogenetic_graph, ppo, pre_training, proximal_operators, proximal_policy_optimization, psro, qube, race_detection, random_forest, receding_horizon_control, reflection, reflective_evolution, representation_learning, reward_free_evolution, rl_dapo, rl_trained, rubric_reward, search_space_analysis, self_attention, self_reflection, shannon_wiener_diversity_index, shap_analysis, spea2, spectral_normalization, structure_tensor_analysis, surrogate_modeling, symbolic_distillation, tensor_cores, test_time_fine_tuning, text_embeddings, three_way_crossover, tiling, total_variation, tree_search, trueskill_ranking, ucb, ucb1_bandit, upper_confidence_bound_for_trees, version_control_system, xgboost
*Shared methods:* alphaevolve, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, data_augmentation, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, game_theory, genetic_algorithm, genetic_programming, gepa, gradient_descent, greedy_algorithm, grpo, heuristic_evolution, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, population_based_optimization, population_management, program_synthesis, prompt_engineering, quality_diversity, reevo, reinforcement_learning, retrieval_augmented_generation, reward_shaping, self_improving_search, shinkaevolve, simulated_annealing, static_code_analysis, supervised_fine_tuning, supervised_learning, transformer, upper_confidence_bound, zero_sum_game
