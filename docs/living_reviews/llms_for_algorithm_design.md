...
*2 fronts detected — snapshot 2026-03-31*

### Front 1 (54 papers) — STABLE

**Density:** 0.05 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, algorithm_discovery, automated_algorithm_design, combinatorial_optimization, circle_packing

*Unique methods:* a_star_search, abductive_reflection, abstract_syntax_tree_analysis, activation_steering, active_learning, adaptive_boltzmann_selection, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, adversarial_generation, agent_based_framework, agentic_reinforcement_learning, algebraic_graph_construction, algorithm_space_response_oracles, autodiff, automated_evaluation, automatic_differentiation, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, basin_hopping, batch_sampling, best_fit_heuristic, best_response_oracle, binary_search, binary_search_algorithm, branch_and_bound, breadth_first_search, catastrophic_forgetting_mitigation, cma_es, code_generation, collaborative_tree_optimization, combinatorial_reasoning, compressed_watch_architecture, conflict_driven_clause_learning, convex_programming, cublas_epilogue, cuda_kernel_optimization, dag_execution, darwin_godel_machine, data_algorithm_co_evolution, data_augmentation, data_diffusion, data_layout_optimization, data_rehearsal, deep_reinforcement_learning, derivative_free_optimization, directed_acyclic_graph, diversity_metrics, diving_heuristics, dynamic_analysis, dynamic_model_selection, dynamic_programming, embedding_similarity, empirical_evaluation, ensemble_heuristics, entailment_graph, entropic_objective, evolutionary_strategy, execution_based_verification, expectation_maximization, explainable_ai, exploratory_landscape_analysis, exponential_moving_average, feature_fusion, fine_tuning, fireworks_algorithm, game_theory, generative_agent_based_modeling, gepa, gigaevo, gradient_correction, graph_algorithms, heuristic_analysis, human_llm_collaboration, hybrid_evolutionary_memory, hydra_configuration, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_models, iterative_debugging, iterative_refinement, iterative_rounding, jax_framework, kd_tree, kernel_fusion, l_bfgs_b, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_aggregator, llm_as_environment_designer, llm_as_evolver, llm_as_executor, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_summarizer, llm_driven_optimization, llm_ensemble, llm_orchestration_router, llm_research_agent, local_refinement, local_verification_loop, lora_fine_tuning, majority_voting, manual_refinement, mcts, mdp_formulation, memoization, meta_agents, meta_evolution, meta_game, meta_level_evolution, meta_prompting, metaheuristics, mixed_integer_programming, mixed_precision_computing, monte_carlo_sampling, monte_carlo_simulation, multi_agent_learning, multi_agent_llm, multi_agent_reasoning, multi_agent_simulation, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_uip_clause_learning, multilayer_perceptron, nash_equilibrium, negative_feedback_learning, neural_networks, novelty_search, nucleus_sampling, numerical_stability, numpy_library, on_policy_learning, open_ended_evolution, openevolve, optimization_based_analyzers, parameter_efficient_fine_tuning, path_credit_propagation, pca, performance_profiling, plan_execute_summarize, polymorphic_execution_strategies, pre_training, preference_alignment, priority_function_design, program_evolution, program_search, progressive_disclosure, prompt_optimization, psro, puct_search, quasi_random_sampling, race_detection, random_hill_climbing, representation_engineering, reverse_engineering, reward_design, reward_model, reward_shaping, rubric_reward, sat_solvers, self_configuring_mas, self_generative_mas, self_improving_ai, self_instruction, self_play, self_rectifying_mas, semantic_delta, shap_analysis, shapely_library, sigmoid_calibration, slsqp, smt_solvers, sparse_solver, spectral_graph_theory, structural_variation, surrogate_modeling, swarm_intelligence, symmetry_breaking_preprocessing, sympy_library, tabu_search, tensor_cores, test_time_learning, text_embeddings, tiling, tool_use, tri_agent_architecture, truncated_svd, ucb1_bandit, ucb_selection, upper_confidence_bound_for_trees, value_scaled_optimization, vivification_sensitivity, wasserstein_distance, xgboost, zero_sum_game
*Shared methods:* alphaevolve, ant_colony_optimization, black_box_optimization, co_evolution, code_embedding, direct_preference_optimization, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, genetic_algorithm, genetic_programming, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, guided_local_search, heuristic_evolution, hyper_heuristics, in_context_learning, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, population_management, program_synthesis, prompt_engineering, quality_diversity, reevo, reflection, reinforcement_learning, retrieval_augmented_generation, self_improving_search, shinkaevolve, simulated_annealing, static_code_analysis, supervised_fine_tuning, supervised_learning

This front focuses on advancing LLM-driven evolutionary search for algorithm design, moving beyond basic code generation to sophisticated meta-evolutionary and multi-agent architectures. Key frameworks like AlphaEvolve, FunSearch, and EoH are extended through innovations such as self-evolving search strategies (EvoX, DGM), cognitive Plan-Execute-Summarize loops (LoongFlow), and adversarial co-evolution of solvers and instances (ASRO, COvolve). The goal is to enhance sample efficiency, generalization, and robustness in discovering high-performing algorithms for complex problems like combinatorial optimization, mathematical discovery, and systems performance.

Significant contributions include EvoX, which introduces a two-level meta-evolutionary framework that jointly evolves solutions and search strategies, outperforming AlphaEvolve and OpenEvolve across nearly 200 tasks. LoongFlow's Plan-Execute-Summarize paradigm reduces evaluations by 60% and achieves 100% success on AlphaEvolve tasks by directing search with lineage-based context. ASRO and COvolve demonstrate that game-theoretic co-evolution of heuristics and adversarial instances yields superior generalization, beating static EoH baselines by 0.5-30% on OBP, TSP, and CVRP. Other notable advancements include ImprovEvolve's modular evolution of local search operators for SOTA Hexagon Packing, LLaMEA-SAGE's use of AST features and SHAP for structural feedback, and DeltaEvolve's semantic deltas reducing token consumption by 37% while improving scores. Papers like Vitvitskyi et al. and Yin et al. validate "proxy evolution" on synthetic tasks for generalizable activation functions and continuous optimization algorithms.
...
**Density:** 0.08 | **Methods:** llm_code_generation, program_synthesis, llm_as_heuristic, llm_evolutionary_search, evolution_of_heuristics | **Problems:** heuristic_evolution, bin_packing, tsp, operator_discovery, algorithm_discovery

*Unique methods:* abductive_reasoning, abstract_syntax_tree, acquisition_function_design, acquisition_functions, actor_critic, adam_optimizer, adaptive_iterated_local_search, adaptive_large_neighborhood_search, adaptive_operator_selection, adaptive_optimization, algorithm_analysis, algorithm_discovery, algorithm_distillation, algorithmic_similarity_measurement, anisotropic_diffusion, ast_manipulation, automated_algorithm_design, automated_heuristic_design, automated_testing, automatic_linearization, barzilai_borwein, bayesian_optimization, behavesim, bilevel_optimization, black_box_distillation, butterworth_filter, causal_discovery, causal_inference, chain_of_thought, character_role_play, code_similarity_metrics, code_validation, competitive_evaluation, concept_learning, continual_learning, contrastive_learning, convexification, counterfactual_regret_minimization, cross_entropy_method, crossover, cumulative_diversity_index, decision_trees, deduplication, differentiable_sampling, differential_evolution, discrete_transformer, distributed_computing, domain_specific_language, dpo, dynamic_resource_allocation, dynamic_time_warping, edit_distance, elitist_strategy, embedding_based_similarity, euclidean_distance, eureka, evo_mcts, evolution_of_thought, evolution_strategies, evoph, execution_guided_program_synthesis, execution_trace_based_similarity, exploitation_exploration_tradeoff, few_shot_learning, few_shot_prompting, fixed_point_iteration, functional_disentanglement, gaussian_process, gaussian_processes, git_based_coordination, global_optimization, gnn, gpt_4o, gridcoder, guided_filter, harmony_search, hgs, hierarchical_clustering, hill_climbing, huber_regularization, human_in_the_loop, hybrid_search, hypothesis_testing, id3_algorithm, image_quality_metrics, island_evolution, iterated_local_search, iterative_repair, kalman_filter, knowledge_transfer, lago, language_hyper_heuristics, large_neighborhood_search, llm_as_heuristic_generator, llm_as_meta_controller, llm_as_research_agent, llm_as_variation_operator, llm_driven_automatic_heuristic_design, llm_guided_evolutionary_search, llm_proposal, llm_rl_trained, machine_unlearning, magnitude_based_pruning, mamba, maturity_aware_heuristic_critic, memetic_algorithm, meta_gradients, meta_guidance, meta_optimization, meta_prompt_evolution, multi_arm_bandit, multi_head_self_attention, multi_population_evolutionary_algorithm, multi_task_learning, mutation, neural_architecture_search, neural_cellular_automata, neural_combinatorial_optimization, neural_operator, neural_program_synthesis, neural_unrolling, nonlinear_programming, nsga2, one_plus_one_es, optimistic_regret_matching, pairwise_comparison, pareto_dominance, penalized_boltzmann_selection, perceiver_attention, phase_unwrapping, phylogenetic_graph, piecewise_linear_encoding, population_based_optimization, ppo, presolving, primal_heuristics, problem_solving_trajectory, procedural_generation, proximal_operators, proximal_policy_optimization, qube, random_forest, ray_tracing, react_paradigm, receding_horizon_control, reflective_code_synthesis, reflective_evolution, representation_learning, reward_free_evolution, rl_dapo, rl_dpo, rl_trained, ruin_and_recreate, search_space_analysis, self_attention, self_consistency, self_reflection, shannon_wiener_diversity_index, spatial_branch_and_bound, spea2, spectral_normalization, structure_based_similarity, structure_tensor_analysis, symbolic_distillation, symbolic_regression, temperature_annealing, template_based_parameter_optimization, test_time_fine_tuning, three_class_experience_replay, three_way_crossover, time_series_forecasting, token_based_similarity, total_variation, trajectory_prediction, transformer, tree_search, tree_structured_parzen_estimator, trueskill_ranking, ucb, upper_confidence_bound, version_control_system, zeroth_order_optimization
*Shared methods:* alphaevolve, ant_colony_optimization, black_box_optimization, co_evolution, code_embedding, direct_preference_optimization, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, genetic_algorithm, genetic_programming, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, guided_local_search, heuristic_evolution, hyper_heuristics, in_context_learning, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_agent, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_reinforcement_learning, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, population_management, program_synthesis, prompt_engineering, quality_diversity, reevo, reflection, reinforcement_learning, retrieval_augmented_generation, self_improving_search, shinkaevolve, simulated_annealing, static_code_analysis, supervised_fine_tuning, supervised_learning

This research front focuses on significantly enhancing LLM-driven evolutionary search frameworks, such as FunSearch, AlphaEvolve, EoH, and ReEvo, for automated algorithm and heuristic design. The core unifying theme is the development of dynamic, adaptive, and often RL-infused mechanisms to overcome limitations in sample efficiency, population diversity, and search robustness. Key innovations include hierarchical adaptive controllers, continuous co-evolution of search components, and explicit causal guidance for mutations, applied across diverse domains from combinatorial optimization to cache replacement policies and multi-agent learning.

Key contributions include AdaEvolve's hierarchical adaptive controller, which achieves state-of-the-art results on Circle Packing and 185 other tasks by dynamically modulating exploration. DyACE redefines heuristic design as a non-stationary control problem, outperforming static baselines on JSSP, TSP, and CVRP by continuously co-evolving operators. EvoTune, Self-Developing, and CALM demonstrate the power of RL-finetuning (DPO/GRPO) for LLMs, leading to superior performance over static FunSearch and GPT-4o baselines. Diversity is addressed by BehaveSim's behavioral similarity metric (DTW), CDEoH's category-aware population management, and EoH-S's complementary heuristic sets. CausalEvolve introduces a causal scratchpad for guided mutations, while Evo-MCTS integrates Monte Carlo Tree Search for improved exploration. STRCMP fuses GNNs with LLMs for structural priors, and TIDE decouples structural design from parameter tuning, significantly boosting efficiency. Rigorous benchmarking, including Berthold et al.'s finding that classical solvers often outperform AlphaEvolve on geometry problems, and Zhang et al.'s observation that simple (1+1)-EPS can rival complex methods, provides crucial reality checks.
