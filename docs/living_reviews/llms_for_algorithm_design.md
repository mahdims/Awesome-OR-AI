...
*2 fronts detected — snapshot 2026-03-24*

### Front 1 (54 papers) — GROWING

**Density:** 0.07 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, operator_discovery, tsp, black_box_optimization, traveling_salesman_problem

*Unique methods:* abductive_reasoning, abstract_syntax_tree, abstract_syntax_tree_analysis, acquisition_function_design, acquisition_functions, actor_critic, adaptive_large_neighborhood_search, adaptive_operator_selection, agentic_reinforcement_learning, algebraic_graph_construction, algorithm_analysis, algorithm_distillation, algorithm_space_response_oracles, algorithmic_similarity_measurement, automated_heuristic_design, automatic_linearization, behavesim, best_fit_heuristic, best_response_oracle, bilevel_optimization, black_box_distillation, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, character_role_play, code_similarity_metrics, collaborative_tree_optimization, concept_learning, contrastive_learning, convexification, cross_entropy_method, cublas_epilogue, cuda_kernel_optimization, cumulative_diversity_index, data_algorithm_co_evolution, data_layout_optimization, data_rehearsal, decision_trees, deduplication, directed_acyclic_graph, distributed_computing, diversity_metrics, diving_heuristics, dpo, dynamic_programming, dynamic_time_warping, edit_distance, elitist_strategy, embedding_based_similarity, empirical_evaluation, euclidean_distance, eureka, evo_mcts, evolution_of_thought, evolution_strategies, evolution_strategy, evolutionary_strategy, evoph, execution_trace_based_similarity, explainable_ai, exploitation_exploration_tradeoff, few_shot_learning, few_shot_prompting, fixed_point_iteration, game_theory, gaussian_process, gaussian_processes, generative_agent_based_modeling, global_optimization, gnn, graph_algorithms, greedy_algorithm, harmony_search, heuristic_evolution, hierarchical_clustering, hill_climbing, human_llm_collaboration, hybrid_search, id3_algorithm, iterative_rounding, kalman_filter, kernel_fusion, knowledge_transfer, lago, language_hyper_heuristics, large_neighborhood_search, llamea, llm_as_heuristic_generator, llm_as_meta_controller, llm_as_variation_operator, llm_guided_evolutionary_search, llm_proposal, mamba, manual_refinement, maturity_aware_heuristic_critic, mcts, mdp_formulation, memetic_algorithm, memoization, meta_agents, meta_game, meta_gradients, meta_optimization, meta_prompt_evolution, mixed_precision_computing, monte_carlo_sampling, multi_agent_simulation, multi_arm_bandit, multi_head_self_attention, multi_objective_optimization, multi_population_evolutionary_algorithm, multi_task_learning, multilayer_perceptron, neural_architecture_search, neural_combinatorial_optimization, neural_operator, neural_unrolling, nonlinear_programming, nsga2, nucleus_sampling, one_plus_one_es, parameter_efficient_fine_tuning, pareto_dominance, path_credit_propagation, penalized_boltzmann_selection, perceiver_attention, population_based_optimization, ppo, preference_alignment, presolving, primal_heuristics, problem_solving_trajectory, program_search, proximal_policy_optimization, qube, random_forest, ray_tracing, react_paradigm, receding_horizon_control, reevo, reflective_code_synthesis, reflective_evolution, representation_learning, rl_dpo, rl_trained, rubric_reward, search_space_analysis, self_attention, self_configuring_mas, self_consistency, self_generative_mas, self_instruction, self_rectifying_mas, self_reflection, shannon_wiener_diversity_index, shap_analysis, shinkaevolve, spatial_branch_and_bound, spea2, spectral_normalization, static_code_analysis, structure_based_similarity, supervised_fine_tuning, surrogate_modeling, symbolic_distillation, tabu_search, template_based_parameter_optimization, tensor_cores, three_class_experience_replay, tiling, token_based_similarity, tree_structured_parzen_estimator, tri_agent_architecture, value_scaled_optimization, wasserstein_distance, xgboost, zero_sum_game
*Shared methods:* adam_optimizer, alphaevolve, ant_colony_optimization, bayesian_optimization, black_box_optimization, branch_and_bound, chain_of_thought, co_evolution, code_embedding, data_augmentation, direct_preference_optimization, eoh, evolution_of_heuristics, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, grpo, guided_local_search, hyper_heuristics, in_context_learning, island_evolution, island_model, large_language_models, learning_to_optimize, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_system, multi_agent_systems, offline_reinforcement_learning, openevolve, policy_space_response_oracles, population_management, program_synthesis, prompt_engineering, quality_diversity, reflection, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, supervised_learning, transformer, upper_confidence_bound
...
### Front 0 (48 papers) — GROWING

**Density:** 0.06 | **Methods:** llm_code_generation, program_synthesis, llm_as_heuristic, evolution_of_heuristics, llm_evolutionary_search | **Problems:** heuristic_evolution, algorithm_discovery, circle_packing, automated_algorithm_design, combinatorial_optimization

*Unique methods:* abductive_reflection, activation_steering, active_learning, adaptive_boltzmann_selection, adaptive_iterated_local_search, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, adversarial_generation, agent_based_framework, algorithm_discovery, anisotropic_diffusion, ast_manipulation, autodiff, automated_algorithm_design, automated_evaluation, automated_testing, automatic_differentiation, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, barzilai_borwein, basin_hopping, batch_sampling, binary_search, binary_search_algorithm, butterworth_filter, cma_es, code_generation, code_validation, combinatorial_reasoning, competitive_evaluation, compressed_watch_architecture, conflict_driven_clause_learning, continual_learning, convex_programming, counterfactual_regret_minimization, crossover, dag_execution, darwin_godel_machine, data_diffusion, deep_reinforcement_learning, derivative_free_optimization, differentiable_sampling, differential_evolution, discrete_transformer, domain_specific_language, dynamic_analysis, dynamic_model_selection, dynamic_resource_allocation, embedding_similarity, ensemble_heuristics, entailment_graph, entropic_objective, execution_based_verification, execution_guided_program_synthesis, expectation_maximization, exponential_moving_average, feature_fusion, fine_tuning, fireworks_algorithm, functional_disentanglement, gigaevo, git_based_coordination, gpt_4o, gradient_correction, gridcoder, guided_filter, heuristic_analysis, hgs, huber_regularization, human_in_the_loop, hybrid_evolutionary_memory, hydra_configuration, hypothesis_testing, image_quality_metrics, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_model_ea, island_models, iterated_local_search, iterative_debugging, iterative_refinement, iterative_repair, jax_framework, kd_tree, l_bfgs_b, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_agent, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_research_agent, llm_as_summarizer, llm_driven_automatic_heuristic_design, llm_driven_optimization, llm_ensemble, llm_in_context_learning, llm_orchestration_router, llm_research_agent, llm_rl_trained, local_refinement, local_verification_loop, lora_fine_tuning, machine_unlearning, magnitude_based_pruning, majority_voting, meta_evolution, meta_guidance, meta_level_evolution, meta_prompting, mixed_integer_programming, monte_carlo_simulation, multi_agent_llm, multi_agent_reasoning, multi_agent_reinforcement_learning, multi_armed_bandit, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_uip_clause_learning, mutation, negative_feedback_learning, neural_cellular_automata, neural_networks, neural_program_synthesis, novelty_search, numerical_stability, numpy_library, on_policy_learning, open_ended_evolution, optimistic_regret_matching, optimization_based_analyzers, pairwise_comparison, pca, performance_profiling, phase_unwrapping, phylogenetic_graph, piecewise_linear_encoding, plan_execute_summarize, polymorphic_execution_strategies, pre_training, priority_function_design, procedural_generation, program_evolution, progressive_disclosure, prompt_optimization, proximal_operators, puct_search, quasi_random_sampling, race_detection, random_hill_climbing, representation_engineering, reverse_engineering, reward_design, reward_free_evolution, reward_model, reward_shaping, rl_dapo, ruin_and_recreate, sat_solvers, self_improving_ai, self_play, semantic_delta, shapely_library, sigmoid_calibration, slsqp, smt_solvers, sparse_solver, spectral_graph_theory, structural_variation, structure_tensor_analysis, swarm_intelligence, symbolic_regression, symmetry_breaking_preprocessing, sympy_library, temperature_annealing, test_time_fine_tuning, test_time_learning, text_embeddings, three_way_crossover, time_series_forecasting, tool_use, total_variation, trajectory_prediction, tree_search, trueskill_ranking, truncated_svd, ucb, ucb1_bandit, ucb_selection, upper_confidence_bound_for_trees, version_control_system, vivification_sensitivity, zeroth_order_optimization
*Shared methods:* adam_optimizer, alphaevolve, ant_colony_optimization, bayesian_optimization, black_box_optimization, branch_and_bound, chain_of_thought, co_evolution, code_embedding, data_augmentation, direct_preference_optimization, eoh, evolution_of_heuristics, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, grpo, guided_local_search, hyper_heuristics, in_context_learning, island_evolution, island_model, large_language_models, learning_to_optimize, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_prompt_optimization, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_system, multi_agent_systems, offline_reinforcement_learning, openevolve, policy_space_response_oracles, population_management, program_synthesis, prompt_engineering, quality_diversity, reflection, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, supervised_learning, transformer, upper_confidence_bound
