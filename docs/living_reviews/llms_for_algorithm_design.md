...
*2 fronts detected — snapshot 2026-04-28*

### Front 0 (62 papers) — STABLE

**Density:** 0.04 | **Methods:** llm_code_generation, llm_evolutionary_search, program_synthesis, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, algorithm_discovery, circle_packing, automated_algorithm_design, combinatorial_optimization

*Unique methods:* RL_PPO, abductive_reasoning, abductive_reflection, abstract_syntax_tree_analysis, abstract_syntax_trees, active_learning, adaptive_boltzmann_selection, adaptive_iterated_local_search, adaptive_operator_selection, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, adversarial_generation, agent_based_framework, agentic_ai, agentic_reinforcement_learning, agglomerative_clustering, algebraic_graph_construction, algorithm_discovery, anisotropic_diffusion, auto_tuning, autodiff, automated_evaluation, automatic_differentiation, automatic_linearization, autoresearch, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, barzilai_borwein, batch_sampling, best_fit_heuristic, bi_dimensional_co_evolution, bi_level_optimization, binary_search, binary_search_algorithm, butterworth_filter, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, cma_es, code_generation, code_validation, collaborative_tree_optimization, combinatorial_reasoning, comparative_error_analysis, compressed_watch_architecture, conflict_driven_clause_learning, continual_learning, convex_programming, convexification, crossover, crossover_operators, cublas_epilogue, cuda_kernel_optimization, dag_execution, darwin_godel_machine, data_augmentation, data_diffusion, data_layout_optimization, data_rehearsal, deep_focus_refinement, deep_reinforcement_learning, derivative_free_optimization, differentiable_sampling, discrete_transformer, distributed_computing, diversity_metrics, dynamic_analysis, dynamic_model_selection, dynamic_programming, dynamic_resource_allocation, elo_rating_system, embedding_similarity, empirical_evaluation, ensemble_heuristics, entropic_objective, evolutionary_strategy, execution_based_verification, expectation_maximization, explainable_ai, exponential_moving_average, feature_fusion, fine_tuning, fireworks_algorithm, functional_disentanglement, generative_agent_based_modeling, geometric_deep_learning, git_based_coordination, global_optimization, gpt_4o, gradient_correction, gradient_free_learning, graph_algorithms, guided_filter, heuristic_analysis, hgs, huber_regularization, human_in_the_loop, human_llm_collaboration, hybrid_evolutionary_memory, hydra_configuration, hypothesis_testing, image_quality_metrics, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_models, iterated_local_search, iterative_debugging, iterative_refinement, iterative_rounding, jax_framework, kalman_filter, kd_tree, kernel_fusion, kernel_generation, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, linear_programming, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_meta_controller, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_research_agent, llm_as_summarizer, llm_driven_automatic_heuristic_design, llm_driven_optimization, llm_ensemble, llm_orchestration_router, llm_rl_trained, local_refinement, local_verification_loop, lora_fine_tuning, machine_unlearning, magnitude_based_pruning, majority_voting, manifold_optimization, manual_refinement, maturity_aware_heuristic_critic, meta_agents, meta_evolution, meta_guidance, meta_level_evolution, meta_prompt_evolution, meta_prompting, mixed_integer_programming, mixed_precision_computing, monte_carlo_sampling, monte_carlo_simulation, multi_agent_llm, multi_agent_reinforcement_learning, multi_agent_simulation, multi_arm_bandit, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_turn_reflection, multi_uip_clause_learning, mutation, mutation_operators, negative_feedback_learning, neural_cellular_automata, neural_networks, nonlinear_programming, novelty_search, nucleus_sampling, numerical_linear_algebra, numerical_stability, numpy_library, offline_reinforcement_learning, on_policy_learning, open_ended_evolution, openevolve, optimization_algorithms, optimization_based_analyzers, pairwise_comparison, parameter_efficient_fine_tuning, path_credit_propagation, penalized_boltzmann_selection, performance_profiling, phase_unwrapping, phylogenetic_graph, piecewise_linear_encoding, plan_execute_summarize, polymorphic_execution_strategies, pre_training, preference_alignment, presolving, primal_heuristics, priority_function_design, procedural_generation, program_evolution, program_search, progressive_disclosure, prompt_optimization, proximal_operators, puct_search, quasi_random_sampling, race_detection, random_hill_climbing, ray_tracing, react_paradigm, receding_horizon_control, reflective_learning, retrieval_augmented_generation, reward_design, reward_free_evolution, reward_model, rl_dapo, rl_dpo, robophd, rubric_reward, ruin_and_recreate, sat_solvers, selection_mechanisms, self_configuring_mas, self_consistency, self_generative_mas, self_improving_ai, self_instruction, self_instrumenting_agents, self_rectifying_mas, semantic_delta, shap_analysis, shapely_library, shinkaevolve, sigmoid_calibration, smt_solvers, sparse_solver, spatial_branch_and_bound, spectral_graph_theory, static_code_analysis, structural_variation, structure_tensor_analysis, surrogate_modeling, swarm_intelligence, symbolic_regression, symmetry_breaking_preprocessing, sympy_library, tabu_search, temperature_annealing, template_based_parameter_optimization, tensor_cores, test_time_learning, text_embeddings, theory_synthesis, three_class_experience_replay, three_way_crossover, tiling, time_series_forecasting, tool_augmented_llm, tool_use, total_variation, trajectory_prediction, tree_structured_search, tri_agent_architecture, truncated_svd, ucb1_bandit, ucb_selection, validation_free_evolution, value_scaled_optimization, version_control_system, vivification_sensitivity, wasserstein_distance, xgboost, zeroth_order_optimization
*Shared methods:* adam_optimizer, alphaevolve, ant_colony_optimization, bayesian_optimization, black_box_optimization, branch_and_bound, chain_of_thought, code_embedding, direct_preference_optimization, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, guided_local_search, hyper_heuristics, in_context_learning, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, policy_space_response_oracles, program_synthesis, prompt_engineering, quality_diversity, reflection, reinforcement_learning, reward_shaping, self_improving_search, simulated_annealing, slsqp, supervised_fine_tuning, supervised_learning, transformer, upper_confidence_bound

This research front focuses on the development of advanced LLM-driven evolutionary search frameworks, extending paradigms like AlphaEvolve, ShinkaEvolve, FunSearch, and LLaMEA. The unifying theme is the meta-evolution of search strategies and the integration of sophisticated feedback mechanisms to achieve sample-efficient and robust algorithm discovery across diverse domains, including combinatorial optimization, GPU kernel optimization, and mathematical problem-solving.

Key contributions include the introduction of meta-evolutionary architectures such as EvoX and DGM-Hyperagents, which enable LLMs to autonomously refine their own search strategies and develop persistent memory. Significant advancements in sample efficiency are demonstrated by ShinkaEvolve's novelty rejection, DeltaEvolve's semantic deltas, and BEAM's adaptive memory for function reuse, drastically reducing evaluation costs. Robustness and quality of feedback are enhanced through LLaMEA-SAGE's AST-based structural guidance, Robusta's adversarial instance analysis, and StitchCUDA's rubric-based reinforcement learning. These innovations have led to new state-of-the-art results, including improved lower bounds for Ramsey numbers by AlphaEvolve, 8 new Best-Known Solutions for CVRP by AILS-AHD, and superior performance in GPU kernel optimization by frameworks like KernelFoundry and AVO, often surpassing human experts and classical solvers.
...
### Front 1 (57 papers) — STABLE

**Density:** 0.07 | **Methods:** llm_code_generation, program_synthesis, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, operator_discovery, tsp, black_box_optimization, bin_packing

*Unique methods:* a_star_search, abstract_syntax_tree, acquisition_function_design, acquisition_functions, activation_steering, actor_critic, adaptive_large_neighborhood_search, algorithm_analysis, algorithm_distillation, algorithm_space_response_oracles, algorithmic_similarity_measurement, ast_manipulation, automated_algorithm_design, automated_heuristic_design, automated_testing, basin_hopping, behavesim, best_response_oracle, bilevel_optimization, black_box_distillation, breadth_first_search, character_role_play, co_evolution, code_similarity_metrics, competitive_evaluation, concept_learning, contrastive_learning, counterfactual_regret_minimization, cross_entropy_method, cumulative_diversity_index, data_algorithm_co_evolution, decision_trees, deduplication, differential_evolution, directed_acyclic_graph, diving_heuristics, domain_specific_language, dpo, dynamic_time_warping, edit_distance, elitist_strategy, embedding_based_similarity, entailment_graph, eoh, euclidean_distance, eureka, evo_mcts, evolution_of_thought, evolution_strategies, evoph, execution_guided_program_synthesis, execution_trace_based_similarity, exploitation_exploration_tradeoff, few_shot_learning, few_shot_prompting, fixed_point_iteration, game_theory, gaussian_process, gaussian_processes, gigaevo, gnn, graph_optimization, gridcoder, harmony_search, heuristic_evolution, hierarchical_clustering, hill_climbing, hybrid_search, id3_algorithm, island_evolution, iterative_repair, k_means, knowledge_transfer, l_bfgs_b, lago, language_hyper_heuristics, large_neighborhood_search, llm_as_agent, llm_as_environment_designer, llm_as_heuristic_generator, llm_as_variation_operator, llm_guided_evolutionary_search, llm_proposal, mamba, mcts, mdp_formulation, memetic_algorithm, memoization, meta_game, meta_gradients, meta_optimization, multi_agent_learning, multi_agent_reasoning, multi_head_self_attention, multi_population_evolutionary_algorithm, multi_task_learning, multilayer_perceptron, nash_equilibrium, neural_architecture_search, neural_combinatorial_optimization, neural_operator, neural_program_synthesis, neural_unrolling, nsga2, one_plus_one_es, optimistic_regret_matching, pareto_dominance, pca, perceiver_attention, population_based_optimization, population_management, ppo, problem_solving_trajectory, program_optimization, proximal_policy_optimization, psro, qube, random_forest, reevo, reflective_code_synthesis, reflective_evolution, representation_engineering, representation_learning, reverse_engineering, rl_trained, search_space_analysis, self_attention, self_play, self_reflection, shannon_wiener_diversity_index, spea2, spectral_normalization, structure_based_similarity, symbolic_distillation, test_time_fine_tuning, token_based_similarity, tree_search, tree_structured_parzen_estimator, trueskill_ranking, ucb, upper_confidence_bound_for_trees, zero_sum_game
*Shared methods:* adam_optimizer, alphaevolve, ant_colony_optimization, bayesian_optimization, black_box_optimization, branch_and_bound, chain_of_thought, code_embedding, direct_preference_optimization, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, exploratory_landscape_analysis, funsearch, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, greedy_algorithm, grpo, guided_local_search, hyper_heuristics, in_context_learning, island_model, island_model_ea, large_language_models, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, metaheuristics, monte_carlo_tree_search, multi_agent_system, multi_agent_systems, multi_armed_bandit, multi_objective_optimization, policy_space_response_oracles, program_synthesis, prompt_engineering, quality_diversity, reflection, reinforcement_learning, reward_shaping, self_improving_search, simulated_annealing, slsqp, supervised_fine_tuning, supervised_learning, transformer, upper_confidence_bound

This research front focuses on architecturally advancing LLM-driven evolutionary search for automated algorithm design, moving beyond basic prompt-and-evaluate loops. A unifying theme is the integration of explicit memory mechanisms, such as textual parameter graphs (TPGO), optimization experience memory (TPGO), entailment graphs (PathWise), and strategy space evolution (SeaEvo). Another dominant aspect is various forms of co-evolution, including solver-instance co-evolution (ASRO, COvolve), policy-environment co-evolution (COvolve), co-evolving destroy-repair operators (G-LNS), co-evolving prompts and heuristics (EvoPH), and data-algorithm co-evolution (DHEvo). These innovations aim to significantly improve sample efficiency, generalization, and robustness in discovering heuristics and algorithms for complex problems like combinatorial optimization, scheduling, and multi-agent systems.

Key contributions include RF-Agent, which uses Monte Carlo Tree Search for reward function design, outperforming Eureka and Revolve on IsaacGym tasks. LaGO introduces a language-guided optimization framework for automated heuristic design, achieving +0.17 QYI on PDPTW. CALM and EvoTune demonstrate successful RL-fine-tuning of LLMs using GRPO and DPO, respectively, leading to better heuristics for Bin Packing and VRP. ImprovEvolve focuses on evolving modular local search operators, achieving new state-of-the-art on Hexagon Packing. EvoStage introduces a stagewise design approach, achieving state-of-the-art HPWL on chip placement with remarkably few evaluations (9-25). ASRO and COvolve leverage game-theoretic co-evolution to produce robust heuristics that generalize better than static baselines on TSP and CVRP. BehaveSim's trajectory-based diversity metric improved FunSearch and EoH on TSP by ~7.8%, while EvoLattice's DAG representation for persistent population evolution achieved +158% on NAS-Bench-Zero by providing fine-grained feedback.

This front is rapidly emerging, characterized by a sophisticated shift from simple LLM code generation to complex, architecturally enhanced evolutionary systems. The trajectory indicates a strong focus on addressing core limitations of LLM-based search, such as sample inefficiency, lack of persistent memory, and poor generalization. Future work will likely involve integrating more advanced meta-learning techniques (e.g., Self-Referential Algorithm Distillation from Evolution Transformer, Group Relative Agent Optimization from TPGO), formalizing optimization guarantees, and scaling these frameworks to larger, more complex real-world problems with multi-objective and constrained settings. The next papers will likely focus on combining these architectural innovations (e.g., MCTS with co-evolution and concept-tree search) and applying them to new domains while rigorously quantifying sample efficiency gains and ensuring stability.
