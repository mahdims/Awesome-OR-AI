...
**Density:** 0.06 | **Methods:** llm_code_generation, llm_evolutionary_search, program_synthesis, llm_as_heuristic, evolution_of_heuristics | **Problems:** heuristic_evolution, tsp, operator_discovery, bin_packing, automated_algorithm_design

*Unique methods:* GRPO, PCA, RL_policy_gradient, SVD, a_star_search, abductive_reasoning, abstract_syntax_tree, abstract_syntax_trees, acquisition_function_design, acquisition_functions, activation_steering, actor_critic, adam_optimizer, agentic_ai, agentic_reinforcement_learning, algebraic_graph_construction, algorithm_analysis, algorithm_discovery, algorithm_distillation, algorithmic_similarity_measurement, anisotropic_diffusion, ant_colony_optimization, ast_manipulation, automated_algorithm_design, automated_heuristic_design, barzilai_borwein, behavesim, bi_dimensional_co_evolution, bi_level_optimization, bilevel_optimization, black_box_distillation, breadth_first_search, butterworth_filter, catastrophic_forgetting_mitigation, causal_discovery, causal_inference, character_role_play, code_similarity_metrics, code_validation, compute_graph_optimization, continual_learning, counterexample_guided_inductive_synthesis, counterfactual_regret_minimization, crossover, crossover_operators, cublas_epilogue, cuda_kernel_optimization, cumulative_diversity_index, data_layout_optimization, data_rehearsal, deduplication, depth_first_search, differentiable_sampling, differential_evolution, direct_preference_optimization, discrete_transformer, distributed_computing, diversity_metrics, dpo, dynamic_analysis, dynamic_time_warping, edit_distance, elitist_strategy, embedding_based_similarity, empirical_evaluation, entailment_graph, euclidean_distance, evolution_of_thought, evolution_strategies, evoph, execution_trace_based_similarity, exploitation_exploration_tradeoff, few_shot_learning, few_shot_prompting, fixed_point_iteration, functional_disentanglement, gaussian_process, gaussian_processes, generative_agent_based_modeling, geometric_deep_learning, git_based_coordination, gnn, graph_algorithms, graph_grounded_optimization, greedy_algorithm, guided_filter, guided_local_search, harmony_search, hierarchical_clustering, hill_climbing, huber_regularization, hypothesis_testing, image_quality_metrics, integer_programming, inverse_density_sampling, kalman_filter, kernel_fusion, lago, language_hyper_heuristics, llm_as_environment_designer, llm_as_heuristic_generator, llm_as_research_agent, llm_guided_evolutionary_search, llm_proposal, machine_unlearning, magnitude_based_pruning, mamba, manifold_optimization, maturity_aware_heuristic_critic, memetic_algorithm, memory_management, meta_gradients, meta_optimization, meta_prompt_evolution, mixed_precision_computing, monte_carlo_sampling, multi_agent_learning, multi_agent_reasoning, multi_agent_simulation, multi_answer_generation, multi_arm_bandit, multi_head_self_attention, multi_population_evolutionary_algorithm, multi_view_retrieval, multilayer_perceptron, multimodal_transformer, mutation, mutation_operators, nash_equilibrium, neural_architecture_search, neural_cellular_automata, neural_combinatorial_optimization, neural_operator, neural_unrolling, nsga2, nucleus_sampling, numerical_linear_algebra, one_plus_one_es, openevolve, optimistic_regret_matching, optimization_algorithms, pairwise_comparison, parameter_efficient_fine_tuning, pareto_dominance, pca, penalized_boltzmann_selection, perceiver_attention, performance_profiling, phase_unwrapping, phylogenetic_graph, piecewise_linear_encoding, population_management, ppo, problem_solving_trajectory, procedural_generation, proximal_operators, proximal_policy_optimization, psro, qube, race_detection, rao_family_metaheuristics, ray_tracing, react_paradigm, reflection, reflective_evolution, reflective_learning, representation_engineering, reverse_engineering, reward_free_evolution, rl_trained, rubric_reward, score_fusion, search_space_analysis, selection_mechanisms, self_attention, self_consistency, self_instruction, self_play, self_reflection, shannon_wiener_diversity_index, shapley_values, shinkaevolve, spea2, spectral_normalization, stochastic_scalarization, structure_based_similarity, structure_tensor_analysis, supervised_fine_tuning, symbolic_distillation, symbolic_regression, tabu_search, temperature_annealing, template_based_parameter_optimization, tensor_cores, theory_synthesis, three_class_experience_replay, three_way_crossover, tiling, time_series_forecasting, token_based_similarity, total_variation, trajectory_prediction, tree_structured_search, ucb, vector_policy_optimization, version_control_system
*Shared methods:* RL_PPO, alphaevolve, auto_tuning, bayesian_optimization, black_box_optimization, chain_of_thought, co_evolution, code_embedding, data_augmentation, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, game_theory, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, grpo, heuristic_evolution, human_in_the_loop, hyper_heuristics, in_context_learning, island_evolution, island_model, island_model_ea, kernel_generation, large_language_models, large_neighborhood_search, learning_to_optimize, linear_programming, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_llm, multi_agent_reinforcement_learning, multi_agent_system, multi_armed_bandit, multi_objective_optimization, offline_reinforcement_learning, policy_space_response_oracles, population_based_optimization, program_synthesis, prompt_engineering, quality_diversity, random_forest, reevo, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, static_code_analysis, supervised_learning, transformer, upper_confidence_bound, zero_sum_game
...
**Density:** 0.06 | **Methods:** llm_evolutionary_search, llm_code_generation, program_synthesis, evolution_of_heuristics, llm_as_heuristic | **Problems:** algorithm_discovery, heuristic_evolution, circle_packing, black_box_optimization, combinatorial_optimization

*Unique methods:* BM25, abductive_reflection, active_learning, adaptive_boltzmann_selection, adaptive_iterated_local_search, adaptive_operator_selection, adaptive_optimization, adaptive_sampling, adaptive_scaling, adaptive_sliding_window, adversarial_generation, agent_based_framework, agglomerative_clustering, algorithm_space_response_oracles, autodiff, automated_evaluation, automated_testing, automatic_differentiation, automatic_linearization, autotuning, bandit_tuned_uip_depth, bandit_tuned_vivification, batch_sampling, best_response_oracle, binary_search, binary_search_algorithm, cma_es, code_generation, coding_agents, collaborative_tree_optimization, combinatorial_reasoning, competitive_evaluation, compressed_watch_architecture, conflict_driven_clause_learning, convex_programming, convexification, cvt_map_elites, dag_execution, darwin_godel_machine, data_diffusion, decision_trees, derivative_free_optimization, directed_acyclic_graph, domain_specific_language, dynamic_model_selection, dynamic_resource_allocation, elo_rating, embedding_similarity, ensemble_heuristics, entropic_objective, eureka, evaluation_hack_detection, execution_based_verification, execution_guided_program_synthesis, expectation_maximization, exploratory_landscape_analysis, exponential_moving_average, feature_fusion, fine_tuning, fireworks_algorithm, framework_design, git_worktree_isolation, global_optimization, gpt_4o, gradient_correction, gradient_free_learning, graph_optimization, gridcoder, heuristic_analysis, hybrid_evolutionary_memory, hydra_configuration, id3_algorithm, importance_sampling, improved_seeding, input_space_partitioning, insight_generation, integration_by_parts_reduction, island_based_evolutionary_algorithm, island_models, iterated_local_search, iterative_debugging, iterative_repair, jax_framework, k_means, kd_tree, knowledge_transfer, langgraph, laporta_algorithm, large_program_database, lineage_based_context_retrieval, lineage_tracking, llm_as_agent, llm_as_aggregator, llm_as_evolver, llm_as_executor, llm_as_meta_controller, llm_as_mutation_operator, llm_as_planner, llm_as_policy, llm_as_summarizer, llm_driven_automatic_heuristic_design, llm_ensemble, llm_orchestration_router, local_verification_loop, lora_fine_tuning, majority_voting, mcts, mdp_formulation, memoization, meta_agents, meta_editing, meta_game, meta_guidance, meta_level_evolution, meta_prompting, metaheuristics, mixed_integer_programming, monte_carlo_simulation, multi_agent_systems, multi_domain_bandit_control, multi_island_evolution, multi_island_model, multi_level_database, multi_task_learning, multi_turn_reflection, multi_uip_clause_learning, negative_feedback_learning, neural_networks, neural_program_synthesis, nonlinear_programming, novelty_search, numerical_stability, numpy_library, on_policy_learning, open_ended_evolution, optimization_based_analyzers, pareto_optimization, path_credit_propagation, plan_execute_summarize, polymorphic_execution_strategies, pre_training, preference_alignment, presolving, primal_heuristics, priority_function_design, program_evolution, progressive_disclosure, prompt_optimization, puct_search, qualitative_user_study, quality_diversity_search, quasi_random_sampling, random_hill_climbing, receding_horizon_control, representation_learning, reward_design, reward_model, reward_shaping, rl_dpo, ruin_and_recreate, sat_solvers, self_configuring_mas, self_generative_mas, self_improving_ai, self_rectifying_mas, semantic_delta, shapely_library, side_information, sigmoid_calibration, smt_solvers, sparse_solver, spatial_branch_and_bound, spectral_graph_theory, surrogate_model_optimization, swarm_intelligence, symmetry_breaking_preprocessing, sympy_library, test_time_fine_tuning, test_time_learning, text_embeddings, tool_use, tree_search, tri_agent_architecture, trueskill_ranking, truncated_svd, ucb1_bandit, upper_confidence_bound_for_trees, user_interface_design, value_scaled_optimization, vivification_sensitivity, wasserstein_distance, zeroth_order_optimization
*Shared methods:* RL_PPO, alphaevolve, auto_tuning, black_box_optimization, branch_and_bound, chain_of_thought, co_evolution, code_embedding, data_augmentation, eoh, evolution_of_heuristics, evolution_strategy, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, game_theory, genetic_algorithm, genetic_programming, gepa, gradient_based_optimization, gradient_descent, grpo, heuristic_evolution, human_in_the_loop, hyper_heuristics, in_context_learning, island_model, island_model_ea, kernel_generation, large_language_models, linear_programming, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_llm, multi_agent_system, multi_armed_bandit, offline_reinforcement_learning, policy_space_response_oracles, population_based_optimization, program_synthesis, quality_diversity, random_forest, reevo, reinforcement_learning, retrieval_augmented_generation, self_improving_search, simulated_annealing, slsqp, supervised_learning, tool_augmented_llm, transformer, upper_confidence_bound, zero_sum_game
...
**Density:** 0.01 | **Methods:** llm_code_generation, llm_evolutionary_search, llm_as_heuristic, evolution_of_heuristics, program_synthesis | **Problems:** heuristic_evolution, operator_discovery, combinatorial_optimization, traveling_salesman_problem, capacitated_vehicle_routing_problem

*Unique methods:* ALNS, abstract_syntax_tree_analysis, adaptive_large_neighborhood_search, asynchronous_execution, autoresearch, basin_hopping, best_fit_heuristic, comparative_error_analysis, concept_learning, confidence_interval_based_certification, contrastive_learning, cross_entropy_method, data_algorithm_co_evolution, deep_focus_refinement, deep_reinforcement_learning, diving_heuristics, dynamic_programming, elo_rating_system, evo_mcts, evolutionary_strategy, explainable_ai, gigaevo, hgs, human_llm_collaboration, hybrid_search, iterative_refinement, iterative_rounding, l_bfgs_b, llm_as_variation_operator, llm_driven_optimization, llm_rl_trained, local_refinement, manual_refinement, meta_evolution, meta_reinforcement_learning, program_optimization, program_search, queue_management, reflective_code_synthesis, replicator_dynamics, rl_dapo, robophd, self_instrumenting_agents, shap_analysis, speculative_completion, staleness_handling, stochastic_approximation, structural_variation, surrogate_modeling, tree_structured_parzen_estimator, ucb_selection, validation_free_evolution, xgboost
*Shared methods:* RL_PPO, alphaevolve, bayesian_optimization, branch_and_bound, co_evolution, evolution_of_heuristics, evolutionary_algorithm, evolutionary_algorithms, evolutionary_computation, evolutionary_search, funsearch, genetic_algorithm, genetic_programming, gepa, island_evolution, large_neighborhood_search, learning_to_optimize, llamea, llm_as_evaluator, llm_as_heuristic, llm_code_generation, llm_evolutionary_search, llm_fine_tuned, llm_in_context_learning, llm_in_the_loop, llm_iterative_refinement, llm_prompt_optimization, llm_research_agent, local_search, map_elites, meta_learning, monte_carlo_tree_search, multi_agent_llm, multi_agent_reinforcement_learning, multi_agent_system, multi_objective_optimization, policy_space_response_oracles, program_synthesis, prompt_engineering, reevo, reinforcement_learning, self_improving_search, simulated_annealing, slsqp, static_code_analysis, tool_augmented_llm
...
**TRUE SYNTHESIS** | score=0.71 | Front 2 → Front 1, Front 0
...
**TRUE SYNTHESIS** | score=0.67 | Front 2 → Front 0, Front 1
...
**TRUE SYNTHESIS** | score=0.64 | Front 1 → Front 0
...
**TRUE SYNTHESIS** | score=0.62 | Front 1 → Front 0, Front 2
